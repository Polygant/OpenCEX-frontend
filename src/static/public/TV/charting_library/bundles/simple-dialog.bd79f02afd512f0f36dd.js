    ...
    EcUf: function (e, t, n) {
      ...
      const M = function (e) {
        ...
        q = function (e, t, n) {
          ...
          if (A.isOpened(r))
            return Object(v.ensureDefined)(A.getDialogPayload(r)).closeHandler;
          ...
          return (
            I.a.render(
              a.a.createElement(
                w.b.Provider,
                { value: n || null },
                a.a.createElement(t, { ...e, onClose: l })
              ),
              i
            ),
            ...
            (e) => {
              t && (t.current = e),
                l.CheckMobile.iOS() &&
                  ...
                  (c.current = e),
                  null !== c.current &&
                    Object(r.disableBodyScroll)(c.current, {
                      allowTouchMove: s(c),
                    }));
            },
            [t]
