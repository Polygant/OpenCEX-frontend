    ...
    miV2: function (e, t, a) {
                ...
                u.a,
                {
                  ...
                  content: p
                    ...
                    : i.createElement(
                        b,
                        null,
                        i.createElement(h.a, { icon: r.SERIES_ICONS[n] })
                      ),
      ...
      function q(e, t) {
        ...
        return (
          ...
          Promise.all(a).then(
            (e) => (
              X.logNormal("Requesting favorites info finished"),
      ...
      function re(e) {
        return (
          e.info.localizedName || Object(R.t)(e.info.name, { context: "study" })
        );
      }
      le.contextType = oe;
      var ce = a("PT1i"),
        ...
        constructor(e) {
          super(e),
            ...
            (this._getMenuPosition = () => {
              const e = Object(K.ensureNotNull)(
                this._timeMenu
      ...
      function ye(e) {
        ...
        return (
          Object(i.useEffect)(() => {
            ...
            r &&
              p &&
              (null === (e = _.current) || void 0 === e || e.scrollIntoView());
          }, [r, p]),
          s.a.createElement(
            "div",
            { ...w, ref: _ },
      ...
      class Le extends s.a.PureComponent {
        ...
        componentWillUnmount() {
          ...
          e.getOnChange().unsubscribe(this, this._handleChangeFavorites),
            ...
            ce.linking.supportedResolutions.unsubscribe(
              this._bindedForceUpdate
            ),
        ...
        render() {
          ...
          (void 0 !== a ? d.concat(a) : d)
            .filter(he.isAvailable)
            .forEach((e) => (h[e] = !0));
          const v =
            void 0 !== a ? Object(he.getTranslatedResolutionModel)(a) : null;
          return s.a.createElement(
            b,
            { id: t },
            c &&
        ...
        _createIntervalForm(e) {
          if (this._customIntervals) {
            ...
            return [
              s.a.createElement(f.a, { key: "custom-interval-separator" }),
              t,
            ];
          }
          return [];
      ...
      const dt = n.enabled("widget"),
        ...
        vt = {
          ...
          loadChartLayout: Object(lt.appendEllipsis)(
      ...
      class gt extends i.PureComponent {
        ...
        _renderMenuItems(e) {
          const {
            ...
            w = e
              ? void 0
              : Object(qe.humanReadableHash)(qe.Modifiers.Mod + 83),
          ...
          return (
            ...
            void 0 !== n &&
              (e ||
                _.push(
                  i.createElement(f.a, { key: "existing-chart-section-begin" })
                ),
              _.push(
                i.createElement(d.b, {
                  key: "rename",
      ...
      function Ut(e) {
        const { serverSnapshot: t, clientSnapshot: n } = e,
          ...
          p = Object(i.useCallback)(async () => {
            ...
            try {
              await Object(Tt.b)(a, "image/png"),
                te.emit("onClientScreenshotCopiedToClipboard");
            } catch (a) {
            ...
            async (e = !1) => {
              ...
              try {
                if (e) await g(a);
                  ...
                  await Object(Tt.b)(e, "text/plain"),
                    te.emit("onServerScreenshotCopiedToClipboard");
                }
                return !0;
              } catch (e) {
                return g(a), !0;
        ...
        return s.a.createElement(
          ...
          s.a.createElement(d.b, {
            ...
            shortcut: Object(qe.humanReadableHash)(
              qe.Modifiers.Mod + qe.Modifiers.Alt + 83
            ),
            theme: Pt,
          }),
          s.a.createElement(d.b, {
            ...
            onClick: p,
            shortcut: Object(qe.humanReadableHash)(
              qe.Modifiers.Mod + qe.Modifiers.Shift + 83
            ),
            theme: Pt,
          }),
          s.a.createElement(d.b, {
            ...
            super(e, t),
              (this._clientSnapshot = async () => {
                ...
                return {
                  ...
                  name: `${Object(_t.shortName)(e)}_${yt.formatLocal(
                    new Date()
                  )}`,
                };
              }),
      ...
      class $t extends s.a.PureComponent {
              ...
              const t = (this._promise = Object(Xt.a)().then((e) => {
                t === this._promise &&
                  (e.showDefaultSearchDialog({
                    ...
                    showSpreadActions:
                      Object(qt.a)() && this.props.isActionsVisible,
                    source: "searchBar",
        ...
        componentDidMount() {
          ce.linking.seriesShortSymbol.subscribe(this._onSymbolChanged),
            Object(Xt.a)();
        }
        componentWillUnmount() {
          ce.linking.seriesShortSymbol.unsubscribe(this._onSymbolChanged),
            (this._promise = null);
        }
        render() {
          ...
          return s.a.createElement(g.b, {
            ...
            className: m(
              t,
              n.enabled("uppercase_instrument_names") && Yt.uppercase
            ),
            theme: Zt,
      ...
      function ea() {
        return (
          ce.linking.seriesShortSymbol.value() ||
          ce.linking.symbol.value() ||
          ""
        );
      }
      var ta = a("9NBK");
