    ...
    "5Ssy": function (e, t, n) {
      ...
      function _(e) {
        ...
        return "symbol" === t.type && t.optional
          ...
          : "bool" === t.type
          ? r.createElement(y, {
              label: Object(o.t)(t.name, { context: "input" }),
              input: t,
              tooltip: n,
            })
          : r.createElement(E.a, {
          ...
          ? Object(w.c)(t)
            ...
            : r.createElement(
                ...
                r.createElement(
                  ...
                  r.createElement(O.a, { title: t.id, name: t.id })
                ),
                t.children.map((e) =>
                  Object(w.b)(e)
              ...
              if (void 0 !== r)
                if (void 0 !== a)
                  if (n.has(r)) {
                    ...
                    let l;
                    o.has(t)
                      ? (l = Object(s.ensureDefined)(o.get(t)))
                      : ((l = new Map()), o.set(t, l)),
    ...
    PjdP: function (e, t, n) {
              ...
              .forEach((e) => {
                ...
                if (1 === a.length) o[n + "$0"] = t;
                  ...
                  const e = a.reduce((e, s, o) => {
                    ...
                    let a;
                    try {
                      a = Object(v.ensureDefined)(
                        Object(v.ensureDefined)(r)[s.id]
                      ).title;
                    } catch (e) {
                      a = s.id;
                    }
      ...
      class q extends s.PureComponent {
        ...
        render() {
          ...
          let i = r.value();
          const l = B
              ? B.get().filter((e) => !V.Interval.parse(e).isRange())
              : [],
            ...
            s.createElement(D.a, {
              ...
              items:
                ...
                p.map((e) => ({
                  ...
                  content:
                    "" === e
                      ? Object(T.t)("Same as chart")
                      : Object(I.getTranslatedResolutionModel)(e).hint,
                }))),
              value: i,
              onChange: this._onChange,
              disabled: n,
      ...
      class H extends s.PureComponent {
        render() {
          return s.createElement(x.b.Consumer, null, (e) =>
          ...
          super(e),
            ...
            (this._onValueByStepChange = (e) => {
              ...
              this._checkValueBoundaries(c).value &&
                (this.setState({ displayValue: v(this.props, c) }),
          ...
          super(...arguments),
            ...
            (this._getColorValueInHex = () => {
              const { color: e } = this.props,
                t = Object(c.a)(e);
              return t
                ? Object(a.isHexColor)(t)
                  ? t
                  : Object(r.rgbToHexString)(Object(r.parseRgb)(t))
                : null;
            }),
            ...
            (this._onColorChange = (e) => {
              ...
              s &&
                ...
                this._setProperty(
                  t,
                  Object(a.generateColor)(String(e), o, !0),
                  h
                ),
            ...
            (this._onOpacityChange = (e) => {
              ...
              this._setProperty(
                ...
                Object(a.generateColor)(
                  n,
                  Object(a.alphaToTransparency)(e),
                  !0
                ),
                d
              );
        ...
        render() {
          ...
          return s.createElement(
            ...
            s.createElement(
              ...
              void 0 !== e
                ? e
                : window.t(Object(o.ensureDefined)(n).name, {
                    context: "input",
                  })
            ),
            s.createElement(
