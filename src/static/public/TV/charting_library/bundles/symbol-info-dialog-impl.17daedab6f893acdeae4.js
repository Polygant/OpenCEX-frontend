  ...
  ["symbol-info-dialog-impl"],
  {
      ...
      (function (e, o) {
        ...
        function M(e) {
          r ||
            ...
            l.render(u.createElement(d, e), r);
        }
        function Y(e) {
        ...
        t.showSymbolInfoDialog = function (e, t) {
          if (
            ...
            if (c && c.length > 0)
              for (const e of c)
                s.push({ title: e.title, propName: e.propertyName });
            var u = 0;
    ...
    ZzxF: function (e, t, n) {
      ...
      function d(e) {
        return o.createElement(
          "div",
          { className: i(l.body, e.className), ref: e.reference },
          e.children
        );
      }
      n("8Rai"), n("cJj4");
    ...
    w3Pp: function (e, t, n) {
      ...
      function a(e, t = []) {
        ...
        const l = Boolean(t.length)
          ? Object(o.t)(e, i) + " " + n.join(" ")
          : s[e] || e;
        return r.set(a, l), l;
      }
    },
