  ...
  ["lt-property-pages-with-definitions"],
  {
      ...
      class s extends n.a {
        _stylePropertyDefinitions() {
          const e = this._source.properties().childs(),
            t = this._source.name();
          return [
            Object(o.a)(this._undoModel, { lineColor: e.linecolor }, t, "Line"),
          ];
        }
      }
    },
      ...
      class x extends l.a {
        ...
        _stylePropertyDefinitions() {
          ...
          const c = t.levelsStyle.childs(),
            ...
            $ = { line: b };
          "extendLines" in t &&
            ((x.extendRight = t.extendLines), ($.extendRightTitle = g)),
            "extendLinesLeft" in t &&
              ((x.extendLeft = t.extendLinesLeft), ($.extendLeftTitle = C)),
            "extendRight" in t &&
              ((x.extendRight = t.extendRight), ($.extendRightTitle = w)),
            "extendLeft" in t &&
              ((x.extendLeft = t.extendLeft), ($.extendLeftTitle = p));
              ...
              n = Object(s.h)(
                {
                  checked: Object(s.b)(
                    this._undoModel,
                    o.visible,
                    `Change ${i} Level ${e} Line Visibility`
                  ),
                  color: Object(s.v)(
                    this._undoModel,
                    o.color,
                    null,
                    `Change ${i} Level ${e} Line Color`
                  ),
                  level: Object(s.b)(
                    this._undoModel,
                    o.coeff,
                    `Change ${i} Level ${e} Coeff`
                  ),
                },
                { id: `${l}LineLevel${e}` }
              );
          ...
          const T = Object(s.e)(
            {
              color: Object(s.v)(
                this._undoModel,
                new u.b(
                  Object(o.ensureNotNull)(this._source.lineColorsProperty()),
                  this._undoModel,
                  ""
                ),
                null,
              ...
              r = Object(n.h)(
                {
                  checked: Object(n.b)(
                    this._undoModel,
                    l.visible,
                    `Change ${i} Level ${o} Line Visibility`
                  ),
                  color: Object(n.v)(
                    this._undoModel,
                    l.color,
                    null,
                    `Change ${i} Level ${o} Line Color`
                  ),
                  width: Object(n.b)(
                    this._undoModel,
                    l.linewidth,
                    `Change ${i} Level ${o} Line Width`
                  ),
                  level: Object(n.b)(
                    this._undoModel,
                    l.coeff,
                    `Change ${i} Level ${o} Coeff`
                  ),
                },
                { id: `${s}LineLevel${o}` }
              );
          ...
          const C = Object(n.e)(
            {
              color: Object(n.v)(
                this._undoModel,
                new c.b(
                  Object(r.ensureNotNull)(this._source.lineColorsProperty()),
                  this._undoModel,
                  ""
                ),
                null,
    ...
    "8ioM": function (e, t, i) {
      ...
      const a = window.t("Color"),
        ...
        w = [
          ...
          {
            value: r.LineToolBarsPatternMode.OpenClose,
            title: window.t("OC Bars"),
          },
          {
            value: r.LineToolBarsPatternMode.Line,
            title: window.t("Line - Close"),
          },
          {
            value: r.LineToolBarsPatternMode.LineOpen,
            title: window.t("Line - Open"),
          },
          {
            value: r.LineToolBarsPatternMode.LineHigh,
            title: window.t("Line - High"),
          },
          {
            value: r.LineToolBarsPatternMode.LineLow,
            title: window.t("Line - Low"),
          },
          {
            value: r.LineToolBarsPatternMode.LineHL2,
              ...
              r = Object(n.h)(
                {
                  ...
                  style: Object(n.b)(
                    this._undoModel,
                    l.linestyle,
                    `Change ${i} Level ${o} Line Style`
                  ),
                },
                {
                  id: `${s}LineLevel${o}`,
                  title: `${l.coeff1.value()}/${l.coeff2.value()}`,
                }
              );
            e.push(r);
          }
          ...
          const j = {
            ...
            O = Object(n.a)(
              ...
              i,
              {
                isEditable: !0,
                isMultiLine: !0,
                customTitles: { text: p, backgroundTitle: g },
              }
            );
          return e.push(O), e;
        }
              ...
              n = Object(l.h)(
                {
                  checked: Object(l.b)(
                    this._undoModel,
                    o.visible,
                    `Change ${s} Level ${t + 1} Line Visibility`
                  ),
                  color: Object(l.v)(
                    this._undoModel,
                    o.color,
                    null,
                    `Change ${s} Level ${t + 1} Line Color`
                  ),
                  width: Object(l.b)(
                    this._undoModel,
                    o.linewidth,
                    `Change ${s} Level ${t + 1} Line Width`
                  ),
                  style: Object(l.b)(
                    this._undoModel,
                    o.linestyle,
                    `Change ${s} Level ${t + 1} Line Style`
                  ),
                  level: Object(l.b)(
                    this._undoModel,
                    o.coeff,
                    `Change ${s} Level ${t + 1} Line Coeff`
                  ),
                },
                { id: `${b}LineLevel${t + 1}` }
              );
          ...
          const _ = Object(l.r)(
            {
              checked: Object(l.b)(
                this._undoModel,
                i.fillBackground,
                `Change ${s} Background Visibility`
              ),
              transparency: Object(l.b)(
                this._undoModel,
                i.transparency,
                `Change ${s} Background Transparency`
              ),
            },
    ...
    DSp8: function (e, t, i) {
      ...
      function c(e, t, i, c) {
        ...
        if (
          ...
          void 0 !== t.fontSize &&
            (d.size = Object(o.b)(e, t.fontSize, `Change ${i} Text Font Size`)),
          void 0 !== t.bold &&
            (d.bold = Object(o.b)(e, t.bold, `Change ${i} Text Font Bold`)),
          void 0 !== t.italic &&
            (d.italic = Object(o.b)(
              e,
              t.italic,
        ...
        return (
          (void 0 === t.backgroundVisible && void 0 === t.backgroundColor) ||
            (a.backgroundTitle =
              (c.customTitles && c.customTitles.backgroundTitle) || s),
            ...
            r = Object(l.j)(
              {
                ...
                unitOptionsValue: Object(l.b)(
                  this._undoModel,
                  e.riskDisplayMode,
                  `Change ${t} Risk Display Mode`
                ),
              },
              {
                id: i + "Risk",
        ...
        _stylePropertyDefinitions() {
          ...
          const C = Object(o.t)(
            ...
            },
            {
              id: n + "Labels",
              title: h,
              optionsItems1: new l.a(w),
              optionsItems2: new l.a(b),
            }
          );
          return e.push(C), e;
        }
          ...
          return [
            ...
            Object(s.k)(
              ...
              },
              {
                id: t + "Degree",
                title: u,
                options: new r.a(this._source.availableDegreesValues()),
              }
            ),
          ];
        }
              ...
              l = Object(n.h)(
                {
                  checked: Object(n.b)(
                    this._undoModel,
                    o.visible,
                    `Change ${i} Fan ${e} Line Visibility`
                  ),
                  color: Object(n.v)(
                    this._undoModel,
                    o.color,
                    null,
                    `Change ${i} Fan ${e} Line Color`
                  ),
                  width: Object(n.b)(
                    this._undoModel,
                    o.width,
                    `Change ${i} Fan ${e} Line Width`
                  ),
                },
                {
                  id: `${s}FanLineLevel${e}`,
                  title: `${o.x.value()}x${o.y.value()}`,
                }
              );
            v.push(l);
          }
              ...
              l = Object(n.h)(
                {
                  checked: Object(n.b)(
                    this._undoModel,
                    o.visible,
                    `Change ${i} Arcs ${e} Line Visibility`
                  ),
                  color: Object(n.v)(
                    this._undoModel,
                    o.color,
                    null,
                    `Change ${i} Arcs ${e} Line Color`
                  ),
                  width: Object(n.b)(
                    this._undoModel,
                    o.width,
                    `Change ${i} Arcs ${e} Line Width`
                  ),
                },
                {
                  id: `${s}ArcsLineLevel${e}`,
                  title: `${o.x.value()}x${o.y.value()}`,
                }
              );
            k.push(l);
          ...
          return [
            Object(o.a)(
              ...
              this._source.name(),
              {
                isEditable: !1,
                isMultiLine: !1,
                customTitles: { text: r, borderTitle: a, backgroundTitle: u },
              }
            ),
            n,
          ];
    ...
    o1gc: function (e, t, i) {
      ...
      class u extends n.a {
        ...
        _stylePropertyDefinitions() {
          const e = this._source.properties().childs();
          return Object(c.a)(this._undoModel, e, this._source.name(), {
            text: a,
          });
        }
      }
    ...
    wm7x: function (e, t, i) {
      ...
      function c(e, t, i, c, d) {
        ...
        return (
          void 0 !== t.showLine &&
            (a.checked = Object(o.b)(e, t.showLine, `Change ${i} Visibility`)),
          void 0 !== t.lineWidth &&
            (a.width = Object(o.b)(e, t.lineWidth, `Change ${i} Width`)),
          void 0 !== t.lineStyle &&
            (a.style = Object(o.b)(e, t.lineStyle, `Change ${i} Style`)),
          void 0 !== t.lineColor &&
            (a.color = Object(o.v)(e, t.lineColor, null, `Change ${i} Color`)),
          void 0 !== t.extendLeft &&
            ((a.extendLeft = Object(o.b)(
              e,
              t.extendLeft,
          ...
          void 0 !== t.leftEnd &&
            (a.leftEnd = Object(o.b)(e, t.leftEnd, `Change ${i} Left End`)),
          void 0 !== t.extendRight &&
            ((a.extendRight = Object(o.b)(
              e,
              t.extendRight,
          ...
          void 0 !== t.rightEnd &&
            (a.rightEnd = Object(o.b)(e, t.rightEnd, `Change ${i} Right End`)),
          Object(o.i)(a, u)
        );
      }
    },
    ...
    zb1A: function (e, t, i) {
      ...
      var o = i("YFKU"),
        ...
        d = i("CA9d"),
        a = i("Cn8r");
      const u = Object(o.t)("#1 (vertical position %, bar)", {
          context: "linetool point",
        }),
            ...
            Object(r.g)(
              {
                checked: Object(r.b)(
                  this._undoModel,
                  e.showImage,
                  `Change ${t} Emoji Visibility`
                ),
                backgroundColor: Object(r.v)(
                  this._undoModel,
                  e.plateColor,
                  null,
                  `Change ${t} Image Background Color`
                ),
                emoji: Object(r.b)(
                  this._undoModel,
                  e.emoji,
