    ...
    PI1I: function (e, t, n) {
      ...
      class M extends i.PureComponent {
        ...
        _getPlaceHolderItem(e) {
          return e
            ? i.createElement(y.a, { className: E.themesButtonIcon, icon: x })
            : B;
        }
        _getThemeItems(e) {
          const {
        ...
        constructor(e) {
          super(e),
            ...
            (this._renderApplyToAllButton = () =>
              i.createElement(p.a, { rule: W.a.TabletNormal }, (e) =>
            ...
            (this._syncApplyToAllVisibility = () => {
              ...
              this.setState({
                isApplyToAllVisible: Object(d.isMultipleLayout)(
                  e.layout.value()
                ),
              });
            }),
            ...
            return i.createElement(
              ...
              i.createElement(
                ...
                i.createElement(
                  ...
                  l.map((e) =>
                    i.createElement(o.a, { key: e.id, definition: e })
                  )
                )
              )
            );
