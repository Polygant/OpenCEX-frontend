(window.webpackJsonp = window.webpackJsonp || []).push([
  ["study-template-dialog"],
  {
    ...
    IDfV: function (e, t, n) {
            ...
            (this._handleChange = (e) => {
              ...
              if (t && "" === a)
                ...
                this.setState({
                  queryValue: a,
                  isOpened: t,
                  active: n ? void 0 : this._getActiveKeyByValue(a),
                }),
                  t && i && i();
              }
              n && s && s(a);
        ...
        _renderSuggestions() {
          const e = this._suggestions(this.state.queryValue),
            t = Object.keys(e).map((t) => {
              const n = c(f.suggestion, {
                [f.selected]: this.state.active === t,
              });
              return a.createElement(
                "li",
        ...
        return (
          ...
          r.a.createElement(
            ...
            r.a.createElement(
                ...
                r.a.createElement(u.a, {
                  label: r.a.createElement(
                    ...
                    r.a.createElement(v.a, {
                      icon: E,
                      className: c(x.hintMark, "apply-common-tooltip"),
                      title: n,
                    })
                  ),
                  onChange: function () {
              ...
              r.a.createElement(
                "div",
                { className: c(x.indicators, C && x.withSuggestions) },
                o
              )
            )
          )
      ...
      function K(e, t, n) {
        const s = () => {
          F.backend.invalidateStudyTemplatesList(),
            F.backend.getStudyTemplatesList().then(t);
        };
      ...
      class H {
        ...
        _prepareData(e, t, n) {
          ...
          return {
            ...
            meta_info: Object(V.a)(this._controller, s.interval),
          };
        }
        _doSave(e, t, n) {
        ...
        _getActualTemplateList() {
          return (
            F.backend.invalidateStudyTemplatesList(),
            F.backend.getStudyTemplatesList()
          );
        }
        _showTemplateSaveRenameDialog(e, t, n) {
          ...
          (this._dialog = new j({
            ...
            saveIntervalHintText: B.format({
              interval: Object(P.translatedIntervalString)(n),
            }),
    ...
    "ML8+": function (e, t, n) {
      ...
      function l(e) {
        ...
        return s.createElement(o.a, {
          className: i(n, a.icon, { [a.dropped]: t }),
          icon: r,
        });
      }
    },
        ...
        render() {
          ...
          return (
            ...
            s.createElement(
              "label",
              { className: o },
              s.createElement(a.a, { ...n, className: e }),
              c
            )
          );
        }
            ...
            i.a.createElement(p.a, { rule: d.a.TabletSmall }, (c) =>
              i.a.createElement(
                ...
                i.a.createElement(
                  ...
                  i.a.createElement(m.a.Consumer, null, (e) =>
                    this._renderChildren(e, c || w)
                  )
                )
              )
            )
      ...
      function l(e) {
        ...
        return s.createElement(
          ...
          s.createElement(
            "span",
            { className: t },
            s.createElement(o.a, { icon: a, className: r.icon })
          )
        );
      }
    },
