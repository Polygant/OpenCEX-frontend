  ...
  ["compare-model"],
  {
          ...
          (this._symbolDataHandlers = new Map()),
            ...
            (this._quoteSessionDataHandler = (e) => {
              const t = Object(o.ensureDefined)(e.symbolname),
                { filtered: s, keepSubscription: n } =
                  this._applyDataFilters(e);
              n || this._unsubscribeSymbols([t]),
          ...
          const t = new Promise((t) => {
            const s = this._clientId + "_SymbolFullName",
              o = (n) => {
                ...
                n && "ok" === n.status
                  ? n.values && i(n.values.pro_name || e)
                  : i(e);
              };
      ...
      const D = new (class {
        ...
        get(e, t = "watchlist") {
          ...
          if (o) {
            ...
            n
              ? (s = n)
              : ((s = new k(e, this._lastSymbolData, t)), o.set(t, s));
          } else {
      ...
      class O {
        constructor(e) {
          (this._contentItemList = new c.a([])),
            ...
            (this._getResolveSymbolPromise = (
              e,
              t = Object(i.makeNextSymbolId)()
            ) => {
              const s = Object(r.encodeExtendedSymbolOrGetSimpleSymbolString)({
                symbol: e,
              });
              return new Promise((e) => {
                Object(o.ensureNotNull)(this._chartSession).resolveSymbol(
                  t,
                  s,
                  (t) => {
                    e(t);
        ...
        _handleApplyProcess(e, t, s) {
          ...
          const i = n.id(),
            ...
            a = s(o, r, n);
          this._saveRecent(r),
            this._addStudyIdToCheckedSymbols(r, i),
            this._showNewItem(a, r, i);
        }
        _handleInitProcess(e, t, s, o) {
          ...
          for (const i of e) {
            ...
            if (void 0 === a || c)
              this._recentSymbolsEnabled && n.push(o(e, r, !1));
            else
              for (const t of a) n.push(o(e, r, !0, this._idToStudyMap.get(t)));
          }
    ...
    qC62: function (e, t, s) {
      ...
      !(function (e) {
        ...
        function s(e) {
          {
            const t = i.enabled("pay_attention_to_ticker_not_symbol")
              ? e.ticker
              : e.full_name;
