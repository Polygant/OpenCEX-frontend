        ...
        constructor(e) {
          super(e),
            ...
            (this._handleMeasure = (e) => {
              ...
              const u = r.height > o;
              if (u) {
                (Object(a.ensureNotNull)(this._scrollWrapRef).style.overflowY =
                  "scroll"),
            ...
            (this._restoreScrollPosition = () => {
              ...
              if (null !== e && t.contains(e))
                ...
                Object(a.ensureNotNull)(this._scrollWrapRef).scrollTop =
                  this._scroll;
            }),
            (this._resize = () => {
              null === this._raf &&
            ...
            (this._handleScroll = () => {
              this._scroll = Object(a.ensureNotNull)(
                this._scrollWrapRef
              ).scrollTop;
            }),
            (this.state = {});
                ...
                s.a.createElement(
                  ...
                  s.a.createElement(
                    "div",
                    {
                      className: o()(
                        l.scrollWrap,
                        !this.props.noMomentumBasedScroll && l.momentumBased
                      ),
                      style: {
