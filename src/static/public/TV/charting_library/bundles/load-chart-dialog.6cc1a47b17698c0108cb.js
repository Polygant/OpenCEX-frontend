          ...
          return Object(n.forwardRef)(({ style: t, ...n }, r) => {
            ...
            return i.a.createElement("div", {
              ...
              style: {
                ...t,
                height:
                  (Object(D.isNumber)(a) ? a : parseFloat(a)) + e + o + "px",
              },
              ...n,
            });
          });
      ...
      function nt(t) {
        const {
          ...
          [y, j] = Object(n.useState)(() =>
            l.getJSON("loadChartDialog.viewState", tt)
          ),
          ...
          x = Object(n.useMemo)(
            () =>
              e.map((t) => ({
                ...t,
                description: `${t.symbol}, ${ot(t.interval)}`,
              })),
            [e]
          );
        Object(n.useEffect)(() => {
      ...
      function s(t, e) {
        return (o, s) => {
          const d = Object(c.ensureNotNull)(t).getBoundingClientRect(),
            ...
            y = {
              x: S - (f === a.FromRightToLeft ? o : 0) + g,
              y: O - (m === r.FromBottomToTop ? s : 0) + p,
            };
