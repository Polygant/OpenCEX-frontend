        ...
        return r.a.createElement(
          "div",
          {
            ...
            onMouseDown: function (e) {
              ...
              e.preventDefault();
              const o = Object(l.ensureNotNull)(
                E.current
              ).getBoundingClientRect();
              N.current = (d ? o.width : o.height) / 2;
              const r = n - t;
              let i =
                D(e.nativeEvent, Object(l.ensureNotNull)(p.current)) -
                N.current;
              i < 0
                ? ((i = 0),
                  (N.current = D(
                    e.nativeEvent,
                    Object(l.ensureNotNull)(p.current)
                  )))
                : i > r * C * I &&
                  ((i = r * C * I),
                  (N.current =
                    D(e.nativeEvent, Object(l.ensureNotNull)(p.current)) - i));
              v(i / C / I), O(!0);
            },
          },
          r.a.createElement(
            "div",
            {
              ...
              onMouseDown: function (e) {
                e.preventDefault(),
                  (N.current = D(
                    e.nativeEvent,
                    Object(l.ensureNotNull)(E.current)
                  )),
                  O(!0);
              },
            },
            r.a.createElement("div", {
              className: c()(m.barInner, d && m["barInner--horizontal"]),
            })
          )
        );
        function x(e) {
      ...
      function m(e) {
        ...
        return r.a.createElement(
          "div",
          {
            ...E,
            ref: t,
            className: i(n, d.scrollWrap),
            style: { visibility: g || p || w ? "visible" : "hidden" },
          },
          N &&
            r.a.createElement(f, {
              size: c - j,
      ...
      function d(e) {
        ...
        return r.a.createElement(
          f,
          {
            ...
            role: n,
            "aria-selected": u,
            className: i(d, z.item, E && z.withIcon, {
              [z.isActive]: w,
              [z.isDisabled]: O || C,
              [z.hovered]: N,
            }),
          ...
          void 0 !== T &&
            r.a.createElement(
              ...
              {
                onClick: A ? v : void 0,
                className: i(z.toolbox, { [z.showOnHover]: I }),
              },
              T
            )
        );
        ...
        return r.a.createElement(
          ...
          r.a.createElement(
            ...
            r.a.createElement(
              "div",
              {
                className: c()(u.title, h && !b && u.active, p && u.mobile),
            ...
            r.a.createElement(
              "div",
              { className: c()(u.details, h && !b && u.active, p && u.mobile) },
              o
            )
          ),
          ...
          [f, v] = Object(o.useState)({
            ...
            onVerticalChange: function (e) {
              v((t) => ({ ...t, scrollPosTop: e })),
                (Object(r.ensureNotNull)(a.current).scrollTop = e);
            },
            onHorizontalChange: function (e) {
              v((t) => ({ ...t, scrollPosLeft: e })),
                (Object(r.ensureNotNull)(a.current).scrollLeft = e);
            },
            visible: s,
          }),
