  ...
  [37],
  {
      ...
      const r = (e) => {
        ...
        return [
          ...
          (e) => {
            if (void 0 !== t) {
              const n = t.value();
              o.a.logNormal(`Changing property value from "${n}" to "${e}"`),
                t.setValue(e);
            }
          },
        ];
        ...
        constructor(e) {
          super(e),
            (this._setValue = (e, t, n) => {
              ...
              s.logNormal(
                `Changing property "${e}" value from "${a.value()}" to "${t}"`
              ),
        ...
        componentDidMount() {
          ...
          e.childNames().forEach((t) => {
            Object(o.ensureDefined)(e.child(t)).subscribe(this, (e) => {
              const n = e.value();
              s.logNormal(`Property "${t}" updated to value "${n}"`),
                this.setState({ [t]: n });
            });
          });
        }
    ...
    "7MId": function (e, t, n) {
        ...
        return o.a.createElement(
          ...
          o.a.createElement(
            i.a,
            {
              ...
              onClose: N,
              position: function () {
                const e = Object(c.ensureNotNull)(
                  y.current
            ...
            o.a.createElement(p.a.Consumer, null, (e) =>
              o.a.createElement(d.a, { ...h, onToggleCustom: b, menu: e })
            ),
            !m && n
          )
        );
      ...
      function y(e) {
        const { name: t, values: n, selectedValues: o, onChange: r } = e,
          s = n.map((e, t) =>
            a.createElement(C, { key: t, value: e.toString() })
          ),
      ...
      function x(e, t) {
        return e
          ? Object(b.generateColor)(e, Object(b.alphaToTransparency)(t))
          : "#000000";
      }
      function O(e) {
    ...
    "Q+1u": function (e, t, n) {
      ...
      class i extends o.a.PureComponent {
        render() {
          return o.a.createElement(
            "div",
            { ref: this.props.reference, className: c.content },
            this.props.children
          );
        }
      }
      (i.InlineRowContext = l),
        ...
        (i.Cell = function (e) {
          ...
          return o.a.createElement(
            ...
            o.a.createElement(
              "div",
              { className: r(c.inner, e.className) },
              e.children
            )
          );
        }),
        (i.Separator = function (e) {
          return o.a.createElement(
            ...
            null,
            o.a.createElement("div", {
              className: r(c.cell, c.separator, c.fill),
            })
          );
        }),
        (i.GroupSeparator = function (e) {
          ...
          return o.a.createElement(
            ...
            null,
            o.a.createElement("div", {
              className: r(c.cell, c.groupSeparator, c.fill, 1 === t && c.big),
            })
          );
        });
    },
    ...
    Si6X: function (e, t, n) {
      ...
      function v(e) {
        ...
        return o.a.createElement(
          "div",
          {
            className: r(g.wrap, a && g.disabled, s),
            onClick: n,
          ...
          onClick: function () {
            ...
            Object(m.a)({
              ...
              showSpreadActions:
                ...
                d.enabled("studies_symbol_search_spread_operators"),
            });
          },
          disabled: r,
          className: s()(
            l,
            d.enabled("uppercase_instrument_names") && w.uppercase
          ),
        });
      }
      function x(e) {
        if ("definition" in e) {
          ...
          return o.a.createElement(
            ...
            o.a.createElement(
              ...
              null,
              o.a.createElement(k, {
                symbol: Object(l.ensureDefined)(c),
                onSymbolChanged: i,
              })
            )
          );
    ...
    WboT: function (e, t, n) {
      ...
      const h = { large: c.b.FontSizeLarge, medium: c.b.FontSizeMedium },
        m = {
          attachment: d.a.top.attachment,
          targetAttachment: d.a.top.targetAttachment,
          attachmentOffsetY: -4,
        };
      function b(e) {
        const {
      ...
      function y(e) {
        ...
        return a.createElement(
          ...
          null,
          void 0 !== e.title &&
            a.createElement("div", { className: C.title }, e.title),
          a.createElement(
            "div",
      ...
      function O(e) {
        ...
        return o.a.createElement(b, {
          ...
          onKeyDown: function (t) {
            if (e.disabled || 0 !== Object(w.modifiersFromEvent)(t.nativeEvent))
              return;
            let n = k,
              a = x;
            ...
            (a.includes(t.keyCode) || n.includes(t.keyCode)) &&
              (t.preventDefault(),
              e.onValueByStepChange(a.includes(t.keyCode) ? -1 : 1));
        ...
        render() {
          ...
          return (
            ...
            a.createElement(
              "label",
              { className: r },
              a.createElement(s.a, { ...n, className: e }),
              i
            )
          );
        }
    ...
    xpzh: function (e, t, n) {
      ...
      function l(e) {
        return o.a.createElement(
          "div",
          { className: s()(c.wrap, e.className) },
          e.children
        );
      }
    },
