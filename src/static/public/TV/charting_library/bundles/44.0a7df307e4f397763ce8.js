  ...
  [44],
  {
        ...
        function m(e, t) {
          ...
          return o.a.createElement(
            ...
            o.a.createElement(
              "div",
              {
                className: r(l.bar, { [l.isActive]: e === n && !t }),
                style: a,
              },
              " "
            )
      ...
      function s(e, t) {
        return (n, s) => {
          const d = Object(l.ensureNotNull)(e).getBoundingClientRect(),
            ...
            j = {
              x: w - (h === i.FromRightToLeft ? n : 0) + f,
              y: E - (m === r.FromBottomToTop ? s : 0) + g,
            };
        ...
        return (
          Object(a.useEffect)(() => {
            ...
            return (
              ...
              () => {
                ...
                u.CheckMobile.iOS() && Object(l.enableBodyScroll)(e),
                  0 === t && Object(c.a)(!1);
              }
            );
          }, []),
          o.a.createElement(
            ...
            o.a.createElement(
              ...
              g === v.currentDrawer &&
                o.a.createElement("div", { className: p.backdrop, onClick: n }),
              o.a.createElement(
                "div",
                {
    ...
    UXjO: function (e, t, n) {
      ...
      function d(e) {
        ...
        return o.a.createElement(l.a, {
          ...
          items:
            ((m = a), m.map((e) => ({ value: e.value, content: e.title }))),
          value: n,
          onChange: u,
          ...Object(c.b)(e),
        });
    ...
    bvfV: function (e, t, n) {
        ...
        constructor(e) {
          super(e),
            ...
            (this._onBlur = (e) => {
              (this._selection = null),
                this.setState({
                  displayValue: k(this.props, this.props.value, V(this.props)),
                  focused: !1,
                }),
            ...
            (this._onValueChange = (e) => {
              ...
              this.setState({ displayValue: a }),
                ...
                r.value &&
                  k(this.props, o) === a &&
                  this.props.onValueChange(o, "input");
            }),
            (this._onValueByStepChange = (e) => {
              ...
              this._checkValueBoundaries(c).value &&
                (this.setState({
                  displayValue: k(this.props, c, V(this.props)),
                }),
      ...
      function V(e) {
        let t = 0;
        return (
          e.inheritPrecisionFromStep && e.step <= 1 && (t = A(e.step)),
          Math.max(e.precision, t) || void 0
        );
      }
      function A(e) {
        const t = Math.trunc(e).toString();
        return Object(j.clamp)(
          y.NumericFormatter.formatNoE(e).length - t.length - 1,
          0,
          15
        );
      }
      ...
      function R(e) {
        ...
        return o.a.createElement(F.a, {
          ...
          onColorChange: function (e) {
            const t = i
              ? Object(B.alphaToTransparency)(Object(T.parseRgba)(i)[3])
              : 0;
          ...
          onOpacityChange: r
            ...
            : function (e) {
                c(
                  Object(B.generateColor)(
                    i,
                    Object(B.alphaToTransparency)(e),
                    !0
                  )
                );
              },
        ...
        return a.createElement(
          ...
          a.Children.map(t, (e) =>
            a.isValidElement(e)
              ? a.createElement(
                  "span",
                  { key: null === e.key ? void 0 : e.key, className: Q.row },
                  e
                )
              : e
          )
                ...
                (function () {
                  ...
                  return (
                    ...
                    o.a.createElement(
                      ...
                      { className: ee.control },
                      o.a.createElement(h, {
                        id: Object(m.a)(t, "line-style-select"),
                        property: n,
                        disabled: A,
                      })
                    )
      ...
      function fe(e) {
        ...
        return o.a.createElement(
          ...
          o.a.createElement(
            X.a,
            null,
            o.a.createElement(he, { property: n, disabled: m })
          )
        );
      }
      var be = n("oWdB");
        ...
        function Z() {
          return o.a.createElement(
            ...
            n &&
              o.a.createElement(
                "div",
                { className: qe.colorPicker },
                o.a.createElement(R, { color: n, disabled: J })
              ),
            r &&
              x &&
              o.a.createElement(Oe, {
                id: Object(m.a)(t, "font-size-select"),
                property: r,
                fontSizes: x,
                disabled: J,
              })
      ...
      class at extends a.PureComponent {
        ...
        _getNewPosition(e) {
          ...
          return (
            Object(tt.isRtl)() && (c = i.width - c - l),
            Object(j.clamp)(c / (i.width - l), 0, 1) * a + t
          );
        }
      ...
      function mt(e) {
        ...
        return o.a.createElement(
          ...
          i &&
            o.a.createElement(x, {
              className: u()(st.input, st.control),
              property: i,
              disabled: g,
            }),
          r &&
      ...
      const Tt = o.a.memo((e) => {
        ...
        return "title" === r.type
          ? o.a.createElement(
              "div",
              { style: t },
              o.a.createElement(xt, { title: r.relatedTitle })
            )
          : o.a.createElement(
              "div",
              { style: t },
      ...
      function Bt(e) {
        ...
        const { className: n, emojis: r, onSelect: i } = e,
          ...
          [p, h] = Object(a.useState)(
            (null === (t = d[0]) || void 0 === t ? void 0 : t.relatedTitle) ||
              ""
          );
        return o.a.createElement(
          "div",
      ...
      const Jt = [
        {
          title: Object(P.t)("recently used", { context: "emoji_group" }),
          emojis: [],
          icon: Rt,
        },
        {
      ...
      function nn(e) {
        ...
        return o.a.createElement(
          ...
          o.a.createElement(
            "div",
            { className: u()(tn.childrenContainer, a && tn.disabled) },
            t
          ),
      ...
      function ln(e) {
        const { value: t, disabled: n, onSelect: r } = e,
          ...
          { current: l } = Object(a.useRef)(
            bt.getJSON("RecentlyUsedEmojis", [t])
          ),
        ...
        const h = Object(a.useCallback)(
          ...
          f =
            ((b = c),
            Object(a.useMemo)(() => ((Jt[0].emojis = b), [...Jt]), [b]));
        var b;
        return o.a.createElement(
          o.a.Fragment,
          null,
      ...
      function dn(e) {
        ...
        if (
          ...
          return o.a.createElement(
            ...
            "general" === t.groupType &&
              o.a.createElement(ke.a.GroupSeparator, { size: 1 })
          );
        }
        switch (t.propType) {
          case "line":
