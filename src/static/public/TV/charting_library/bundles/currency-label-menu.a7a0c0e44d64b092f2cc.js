  ...
  ["currency-label-menu"],
  {
    ...
    "9agd": function (e, t, n) {
      ...
      function w(e) {
        ...
        return i.a.createElement(
          ...
          void 0 !== c &&
            i.a.createElement(
              "div",
              { className: b()(O.description, u && O.small) },
              m(c)
            )
        );
        function m(e) {
      ...
      function k(e, t, n) {
        ...
        return (
          c.a.render(i.a.createElement(z, { ...r }), o),
          { close: a, isOpened: () => null !== o }
        );
      }
      ...
      function l(e, t) {
        return (n, l) => {
          const u = Object(r.ensureNotNull)(e).getBoundingClientRect(),
            ...
            A = {
              x: E - (f === c.FromRightToLeft ? n : 0) + p,
              y: b - (m === a.FromBottomToTop ? l : 0) + C,
            };
    ...
    "ML8+": function (e, t, n) {
      ...
      function s(e) {
        ...
        return o.createElement(a.a, {
          className: i(n, c.icon, { [c.dropped]: t }),
          icon: r,
        });
      }
    },
    ...
    aWqZ: function (e, t, n) {
      ...
      function a(e, t, n) {
        ...
        for (const e of f)
          m.actions.push(
            c(e.id, e.code, t.selectedCurrency === e.id, () => r(e.id))
          );
    ...
    hpdS: function (e, t, n) {
      ...
      function a(e, t, n) {
        ...
        if (null !== s) {
          const e = c(
            s,
            Object(o.ensureDefined)(u.get(s)),
            Object(o.ensureDefined)(d.get(s)),
            !0,
            () => {}
          );
          m.actions.push(e);
        ...
        for (const e of f)
          for (const t of e.units)
            t.id !== s &&
              l.has(t.id) &&
              m.actions.push(c(t.id, t.name, t.description, !1, () => r(t.id)));
        m.actions.length > 0 && a.push(m);
          ...
          for (const e of f) {
            ...
            for (const n of e.units)
              n.id === s ||
                l.has(n.id) ||
                t.actions.push(
                  c(n.id, n.name, n.description, !1, () => r(n.id))
                );
        ...
        for (const e of f) {
          ...
          for (const n of e.units)
            n.id === s ||
              l.has(n.id) ||
              t.actions.push(c(n.id, n.name, n.description, !1, () => r(n.id)));
          t.actions.length > 0 && a.push(t);
        }
        return a;
      }
