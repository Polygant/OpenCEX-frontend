  ...
  ["chart-widget-gui"],
  {
    ...
    EV8o: function (e, t, s) {
      ...
      function o(e, t, s, o, l) {
        ...
        return (
          Object(i.isString)(r) ? (a.innerHTML = r) : a.appendChild(r),
          n.appendChild(a),
          n
        );
      }
    ...
    TGRH: function (e, t, s) {
      ...
      class A {
        constructor(e, t, s) {
          (this._widget = Object(i.ensureNotNull)(
            Object(r.a)(W).querySelector(".control-bar-wrapper")
          )),
            (this._controlBar = Object(i.ensureNotNull)(
              this._widget.querySelector(".control-bar")
            )),
            (this._back = Object(i.ensureNotNull)(
              Object(r.a)(T).querySelector(".control-bar__btn--back-present")
            )),
    ...
    ZKFq: function (e, t, s) {
      e.exports = {
        ...
        "maximize-animation-up-bracket":
          "maximize-animation-up-bracket-2fnY2ZKI",
        "maximize-animation-down-bracket":
          "maximize-animation-down-bracket-2fnY2ZKI",
        "minimize-animation-up-bracket":
          "minimize-animation-up-bracket-2fnY2ZKI",
        "minimize-animation-down-bracket":
          "minimize-animation-down-bracket-2fnY2ZKI",
        up: "up-2fnY2ZKI",
    ...
    lvAK: function (e, t, s) {
      ...
      class c {
        ...
        _render() {
          this._renderActions(),
            this._parentEl.classList.add(h.paneControls),
        ...
        _renderActions() {
          ...
          (this._listActionsElements.up = Object(d.a)(
            this._actions.up,
            h.button,
            h.buttonIcon,
            u.blockHidden,
          ...
          for (const e of Object.keys(this._listActionsElements))
            Object(n.ensureNotNull)(this._listActionsElements[e]).classList.add(
              h.newButton
            );
        ...
        _updateActionVisibilities(e, t) {
          Object(n.ensureNotNull)(
            this._listActionsElements[e]
          ).classList.toggle(u.blockHidden, !t);
        }
        _updateActionTitle(e, t) {
          Object(n.ensureNotNull)(this._listActionsElements[e]).setAttribute(
            "title",
            t
          );
        }
        ...
        _updateThemedColor(e) {
          if (e.length > 0) {
            ...
            this._parentEl.style.color = Object(a.rgbaToString)([
              t,
              s,
              i,
              Object(a.normalizeAlphaComponent)(0.8),
            ]);
      ...
      class I {
        ...
        _getCloseButtonVisibility() {
          ...
          return (
            e.containsMainSeries() ||
              e.isMaximized() ||
              O ||
              (t = e.dataSources().some((e) => Object(l.isStudy)(e))),
            t
          );
        }
        _onCloseButton() {
        ...
        _getUpButtonVisibility() {
          const e = this._paneWidget.state();
          return (
            this._model.model().panes().indexOf(e) > 0 && !e.isMaximized() && !O
          );
        }
        ...
        _getMaximizeButtonVisibility() {
          const e = this._paneWidget.state();
          return (
            this._model.model().panes().length > 1 && !e.isMaximized() && !O
          );
        }
    ...
    sAH5: function (e, t, s) {
      ...
      class f {
        constructor(e, t, s) {
          (this._el = null),
            ...
            this._loading.subscribe(
              (function (e, t) {
                ...
                return (i) => {
                  clearTimeout(s),
                    Boolean(i) ? e() : (s = setTimeout(e, t, !1));
                };
          ...
          for (let e = 0; e < this._titlesSpawns.length; e++)
            this._titlesSpawns[e].subscribe(
          ...
          (this._withActions = s.withActions),
            ...
            this._withActions &&
              ((this._showActionsHandler = Object(p.c)(
                this._showActions.bind(this)
              )),
              (this._hideActionsHandler = Object(p.c)(
                this._hideActions.bind(this)
              )),
              (this._selectedSourceHandler = Object(p.c)(
        ...
        destroy() {
          ...
          if (
            ...
            Object(i.ensureNotNull)(this._el.parentNode).removeChild(this._el),
              (this._el = null);
          }
        }
        getHeight() {
        ...
        _render() {
          this._renderTitle(),
            ...
            this._firstBlockWrapper.appendChild(
              Object(i.ensureNotNull)(this._titleParentEl)
            ),
            null !== this._actionsParentEl &&
        ...
        _renderTitle() {
          ...
          for (let t = 0; t < this._titlesSpawns.length; t++) {
            ...
            s.classList.add(y.title, M[t], "apply-overflow-tooltip"),
              (s.dataset.name = "legend-source-title");
            const i = this._titlesSpawns[t].value();
            i.length > 0
              ? (s.appendChild(document.createTextNode(i)),
                s.classList.add(y.withDot))
        ...
        _updateTitlesHandler(e, t) {
          const s = Object(i.ensureNotNull)(this._titleElements[e]),
            o = 0 === t.length;
          s.classList.toggle(m.blockHidden, o),
            s.classList.toggle(y.withDot, !o),
            v(s, t);
        }
        _updateStates(e) {
        ...
        _updateValuesHTMLElHandler(e, t) {
          v(Object(i.ensure)(this._valuesElements[e].value), t),
            this._updateShowValues();
        }
        ...
        _updateValueVisibleHandler(e, t) {
          const s = Object(i.ensure)(this._valuesElements[e].value).closest(
            "." + y.valueItem
          );
        ...
        _addStatusesWidget(e, t, s) {
          (this._statusesWrapper = document.createElement("div")),
            ...
            Object(i.ensureNotNull)(this._firstBlockWrapper).appendChild(
        ...
        _updateDisabledState() {
          null !== this._el &&
            ...
            this._disabled.value()
              ? (this._el.classList.add(y.disabled),
        ...
        _updateLoadingState() {
          ...
          this._el.classList.toggle(y.loading, e),
        ...
        _updateCustomTextColor() {
          ...
          const t = Object(i.ensureNotNull)(
            this._valuesParentEl
          ).querySelectorAll("." + y.valueTitle);
          for (let s = 0; s < t.length; s++) t[s].style.color = e;
          Object(i.ensureNotNull)(this._el).classList.toggle(
      ...
      class B {
        constructor(e, t, s) {
          (this._el = null),
            ...
            (this._showObjectTreeHandler = Object(p.c)(
      ...
      class R {
        ...
        addMainDataSource(e, t) {
          this._renderMainDataSourceEl(),
            (this._mainDataSourceRenderer = new E(
              e,
              Object(i.ensureNotNull)(this._mainDataSourceEl),
              {
        ...
        addDataSources(e, t) {
          ...
          const s = Object(i.ensureNotNull)(
          ...
          for (let i = 0; i < e.length; i++) {
            const o = e[i],
              l = new k(o, s, {
                ...
                hideInvisibleHover: j(t[i].visibleWidgetsCount, (e) =>
                  Boolean(e)
                ),
        ...
        _setCustomBg() {
          ...
          if (e) {
            ...
            i = Object(r.rgbaToString)([
              e,
              o,
              l,
              Object(r.normalizeAlphaComponent)(1 - s / 100),
            ]);
          }
      ...
      class Q {
        constructor(e, t, s, i, o) {
          (this._values = new l.a([])),
            ...
            (this._disabledOnInterval = new l.a(
        ...
        onToggleDisabled() {
          ...
          this._model.setProperty(
            e,
            t,
            `${t ? "Show" : "Hide"} ${this._source.title()}`
          ),
      ...
      class re extends Q {
        ...
        onShowSettings() {
          this._source.userEditEnabled() &&
            this._callbacks.showGeneralChartProperties(G.TabNames.symbol);
        }
      ...
      class Ve extends Q {
        ...
        destroy() {
          super.destroy();
          const e = this._model.model().properties()
        ...
        _updateValues() {
          ...
          if (0 === t.length) {
            ...
            for (let e = 0; e < s.length; e++) {
              const i = t[e],
                o = s[e];
              i.value.setValue(o.value()),
                i.color.setValue($(o.color())),
                i.visible.setValue(o.visible());
            }
          }
        }
        _updateStates() {
        ...
        _isSymbolLikeStudy() {
          return (
            this._source instanceof ge.study_Overlay ||
            this._source instanceof we.a
          );
        }
        ...
        _createActions() {
          if (!this._options.readOnlyMode) {
            ...
            Ee &&
              Ce &&
              (!Object(de.isStudy)(this._source) ||
                new ue.a(this._source.metaInfo()).hasUserEditableOptions()) &&
              this._actions.push({
                iconMap: new Map([
                  ["large", _e],
                  ["small", _e],
      ...
      function De(e, t, s, i, o, l) {
        return (function (e, t, s, i, o) {
          ...
          if (void 0 !== n) {
            ...
            void 0 !== e &&
              e.length > 0 &&
              (l.push(...e), l.push(new xe.Separator()));
          }
            ...
            t.showOpenMarketStatus &&
              l.push(
                new xe.Action({
                  ...
                  onExecute: () =>
                    Ae(e, Te.b, "Change open market status visibility"),
                })
              );
          if (
            (l.push(
              new xe.Action({
                ...
                onExecute: () =>
                  Ae(e, a.showSeriesOHLC, "Change OHLC Values Visibility"),
              })
            ),
            l.push(
              new xe.Action({
                ...
                onExecute: () =>
                  Ae(e, a.showBarChange, "Change Bar Change Visibility"),
              })
            ),
      ...
      function tt(e) {
        ...
        const t = e % 60,
          s = (e - t) / 60;
        return (
          Object(Ue.numberToStringWithLeadingZero)(s, 2) +
          ":" +
          Object(Ue.numberToStringWithLeadingZero)(t, 2)
        );
      }
      const st = {
        [Ge.WeekDays.MONDAY]: {
      ...
      class rt {
        constructor(e) {
          ...
          const t = e;
          (this._symbolInfo = Object(Xe.b)(
            t.symbolInfo.bind(t),
            t.dataEvents().symbolResolved()
          )),
        ...
        currentTimeValue() {
          return null === this._todayInExchangeTime
            ? -1
            : Ze.get_minutes_from_midnight(this._todayInExchangeTime) /
                Ze.minutesPerDay;
        }
        timezone() {
              ...
              for (const i of Object.keys(e)) {
                ...
                r.start.isFirstOrLastPoint ||
                  ...
                  d.end.isFirstOrLastPoint ||
                    (d.showEndForFirstEntry = ot(l, e[a].entries));
              }
              var t, s;
            })(a)),
            ...
            if (null !== t) {
              ...
              void 0 !== o &&
                s.set(
                  ...
                  new $e.SessionSpec(
                    e.timezone,
                    o["session-display"] || o.session,
                    "",
                    o["session-correction"]
                  )
                );
            }
          }
        ...
        _updateTodayWithOffsets(e) {
          ...
          this._todayInExchangeTime = Ze.get_cal_from_unix_timestamp_ms(
            Ze.get_timezone(e.timezone),
            Date.now() + t
          );
        }
      }
      ...
      function gt(e) {
        return (
          bt.has(e) || bt.set(e, Object(pt.randomHash)()),
          Object(i.ensureDefined)(bt.get(e))
        );
      }
      const wt = new Map([
          [0, mt.green],
      ...
      function Mt(e) {
        ...
        const r = i.map((e) =>
            ht.a.createElement(
              "div",
              { key: gt(e), className: mt.timeMark },
              e.title
            )
          ),
      ...
      class xt {
        ...
        _updateIconClassName(e) {
          null !== e
            ? this._iconClassNames.setValue([Vt.statusItem, e])
      ...
      function At(e) {
        ...
        t.includes(e) ||
          (t.push(e),
          Wt.setJSON("tv.alreadyBlinkedStatuses", t),
          Ot.setValue(Lt()));
      }
      ...
      window.t("Create a free account"),
        window.t("Learn more"),
        Object(Ct.b)(window.t("Fill out Exchange Agreements"));
      class hs extends xt {
        constructor(e, t, s) {
        ...
        async _getHtmls() {
          ...
          try {
            ...
            Rt.logError(
              "Can't get exchange description, reason: " + Object(Ht.a)(e)
            );
          }
          for (const l of e)
            if (
              ...
              [
                ...
                null !== i &&
                  "DelayNoRealtime" === l &&
                  t[l].push(ts.format({ description: `<b>${i}</b>` })),
                ...
                this._options.subscriptionFullInfo &&
                  Ft.includes(l) &&
                  t[l].push(
                    Qt.format({ listedExchange: this._model.listedExchange() })
                  )),
              "EOD" === l && (t[l] = [ss]),
              "TickByTick" === l &&
              ...
              0,
                t[l].push(
                  ns.format({ symbolName: s, exchange: o }),
                  "" !== e ? rs.format({ exchange: e }) : as
                );
            }
          ...
          for (const i of t)
            if (
              ...
              0,
                (s[i] =
                  "" !== t
                    ? qt.format({ exchange: t, originalExchange: $t })
                    : $t);
            }
      ...
      class vs extends xt {
        ...
        setSource(e, t) {
          this._dataSourceErrorStatus.destroy(),
            (this._dataSourceErrorStatus = kt(
              () => e.statusProvider({}).errorStatus(),
              t
            )),
      ...
      class ks extends xt {
        constructor(e, t) {
          super(t),
            (this._booleanStatus = new l.a(!1).spawn()),
            this.updateStatus(e);
        }
        destroy() {
      ...
      class zs {
        ...
        _render(e) {
          this._el.classList.add(Vt.statusItem, Vt[this._size]),
      ...
      class _i {
        ...
        _isPrimaryWidgetShown() {
          ...
          return (
            null !==
              (t =
                null === (e = this._isSymbolInvalid) || void 0 === e
                  ? void 0
                  : e.value()) &&
            void 0 !== t &&
            t
        ...
        _recreateWidgets() {
          ...
          if (this._options.sourceStatusesEnabled) {
            if (
              ...
              null === (e = this._isSymbolInvalid) ||
                void 0 === e ||
                e.destroy();
              const t = this._source;
              if (
                (Object(de.isStudy)(t) || Object(de.isStudyStub)(t)
                  ? (this._isSymbolInvalid = kt(
                      () => t.isSymbolInvalid() && t.isActualInterval(),
                      [t.onStatusChanged(), t.onIsActualIntervalChange()]
                    ))
                  : (this._isSymbolInvalid = Object(Re.a)(
                      () => t.isSymbolInvalid(),
                      t.onStatusChanged()
                    )),
                ...
                this._statusWidgetInfos.push(t),
                  this._renderer.addStatusModel(t);
              } else
          ...
          if (this._options.marketStatusEnabled) {
            ...
            if (null === this._marketStatusViewModel) {
              this._marketStatusViewModel = new ci(
                e,
                this._size,
              ...
              null !== e &&
                ((this._sessionWidget = new ft(this._source)),
          ...
          if (this._options.dataUpdateModeEnabled) {
            ...
            if (null === this._dataUpdatedModeViewModel) {
              this._dataUpdatedModeViewModel = new hs(
                e,
                this._size,
      ...
      class Ei {
        constructor(e, t, s, i, o, a, r) {
          ...
          const u = this._model.model().properties().paneProperties
              .legendProperties.showBackground,
            c = new l.a(u.value());
          u.subscribe(this, () => {
            c.setValue(u.value());
          });
          const _ = this._model.model().properties().paneProperties
        ...
        onShowLegendWidgetContextMenu(e, t) {
          ...
          const s = new Map();
          for (const e of Array.from(this._customLegendWidgetsMap.keys())) {
            const t = Object(i.ensureDefined)(
                this._customLegendWidgetsMap.get(e)
              ),
              o = new Map();
          ...
          s > -1
            ? (e.splice(s, 1),
              Si ||
                ...
                (this._mainSeriesStatusWidget = new gi(
                  t,
                  this._model.model(),
            ...
            if (null !== t && null !== s) {
              ...
              if (e > l + 1) {
                ...
                return (
                  ...
                  void this._collapsedDataSourcesCount.setValue(e - l)
                );
              }
            }
          }
