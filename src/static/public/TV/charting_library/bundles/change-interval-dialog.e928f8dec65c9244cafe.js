(window.webpackJsonp = window.webpackJsonp || []).push([
  ["change-interval-dialog"],
  {
    ...
    iT0o: function (e, t, n) {
        ...
        const { initVal: t, selectOnInit: n, onClose: o } = e,
          ...
          g = (function (e, t) {
            return Object(r.useMemo)(() => {
              ...
              if (!n) return !1;
              const r = t.unit;
              if ("R" === r && t.qty > Object(w.getMaxResolutionValue)("R"))
                n = !1;
              else if (null === r || "H" === r) {
                t.qty * ("H" === r ? 60 : 1) >
                  Object(w.getMaxResolutionValue)("1") && (n = !1);
              } else
                "S" === r
                ...
                "form",
                {
                  ...
                  onSubmit: function (e) {
                    ...
                    n &&
                      ...
                      g &&
                      ((r = n),
                      Object(w.setLastUsedResolution)(r),
                      f.linking.interval.setValue(r));
                    var r;
                    null == o || o();
                  },
                },
      ...
      function N(e) {
        if (
          C.b.isOpened("ChangeIntervalDialog") ||
          C.b.isOpened("SymbolSearch")
        )
          return;
        const t = document.createElement("div"),
          ...
          l = i.a.createElement(j, {
            ...
            selectOnInit: r,
            onClose: function () {
              a.a.unmountComponentAtNode(t),
                C.b.setAsClosed("ChangeIntervalDialog"),
                null == o || o();
            },
          });
