  ...
  [25],
  {
    ...
    EBrf: function (e, t, n) {
      ...
      function a(e, t = "&nbsp;") {
        ...
        const a = n.split(".");
        return (
          a[0].replace(/\B(?=(\d{3})+(?!\d))/g, t) + (a[1] ? "." + a[1] : "")
        );
      }
    },
    FadI: function (e, t, n) {
      ...
      function a(e) {
        return (null == e ? void 0 : e.aborted)
          ...
          : new Promise((t, n) => {
              null == e ||
                e.addEventListener("abort", () => n(o()), { once: !0 });
            });
      }
      function o() {
    ...
    "ML8+": function (e, t, n) {
      ...
      function i(e) {
        ...
        return r.createElement(o.a, {
          className: a(n, c.icon, { [c.dropped]: t }),
          icon: s,
        });
      }
    },
    ...
    SAe1: function (e, t, n) {
      ...
      class c extends r.Component {
        ...
        shouldComponentUpdate(e, t) {
          return (
            !o()(e, this.props) ||
            !o()(t.rules, this.state.rules) ||
            !o()(t.matches, this.state.matches)
          );
        }
        componentDidMount() {
    ...
    p04v: function (e, t, n) {
      ...
      function u(e) {
        ...
        if (
          i.b.isOpened("SymbolSearch") ||
          i.b.isOpened("ChangeIntervalDialog")
        )
          return;
        ...
        function I() {
          o.unmountComponentAtNode(T),
            i.b.setAsClosed("SymbolSearch"),
            x && x();
        }
        return o.render(j, T), i.b.setAsOpened("SymbolSearch"), { close: I };
      }
    },
    poJS: function (e, t) {
      e.exports =
    ...
    qC62: function (e, t, n) {
      ...
      !(function (e) {
        ...
        function n(e) {
          {
            const t = o.enabled("pay_attention_to_ticker_not_symbol")
              ? e.ticker
              : e.full_name;
        ...
        (e.fromQuotesResponse = function (e) {
          const { values: n, symbolname: r, status: a } = e;
          ...
          (e.fromSymbolSearchResult = function (e, t) {
            {
              ...
              return o.enabled("pay_attention_to_ticker_not_symbol")
                ? Object(a.ensureDefined)(null != n ? n : r)
                : Object(a.ensureDefined)(r);
            }
          }),
          (e.fromSymbolInfo = n),
    ...
    "rC+j": function (e, t, n) {
      ...
      function i(e) {
        return e.reduce(
          (e, t) =>
            "symbol" === t.type && a.a.test(t.value)
              ? e + `'${t.value}'`
              : e + t.value,
          ""
        );
        ...
        for (let a = 0; a < e.length; a++) {
          ...
          switch (o.type) {
            ...
            case "power":
              ...
              break;
            case "openBrace":
              (r = { minPrecedence: 1 / 0, openBraceIndex: a }), n.push(r);
              break;
            case "closeBrace": {
              if (((r = n.pop()), !r)) break;
              ...
              (!l(null == c ? void 0 : c.type) ||
                (null == c ? void 0 : c.precedence) <= r.minPrecedence) &&
                (!l(null == o ? void 0 : o.type) ||
                  (null == o ? void 0 : o.precedence) <
      ...
      function b(e, t) {
        const { value: n, selectionStart: r } = e,
          o = Object(a.b)(t ? n.toUpperCase() : n),
          c = (function (e, t) {
            for (let n = 0; n < e.length; n++) {
              const r = e[n],
                a =
                  ...
                  "number" === r.type;
              if (r.offset <= t && t <= r.offset + r.value.length && a)
                return r;
            }
            return null;
          })(o, r || 0);
      ...
      const s = c,
        i = r.forwardRef((e, t) => {
          const {
            ...
            x = a(v, b.button, h && "apply-common-tooltip", {
              [b.isActive]: s,
              [b.isOpened]: i,
            ...
            O =
              n &&
              ("string" == typeof n
                ? r.createElement(o.a, { className: b.icon, icon: n })
                : r.cloneElement(n, {
    ...
    uTDg: function (e, t, n) {
      ...
      function E(e) {
        ...
        return a.a.createElement(
          ...
          a.a.createElement("div", { className: y.childrenWrapper }, t)
        );
      }
      var x = n("1LIl"),
        O = n("H9Gg"),
      ...
      function w(e) {
        const {
          ...
          f = Object(r.useMemo)(() => Object(O.a)(m), [m]),
          b = i && !u,
          v = c()(
            N.container,
        ...
        return a.a.createElement(
          "div",
          { className: c()(!d && N.wrap, u && N.libAllExchange), onClick: p },
          a.a.createElement(
            "div",
            { className: v },
            a.a.createElement(
      ...
      var S = n("vqb8"),
        ...
        M = n("6rj1"),
        _ = n("Iruf");
      const L = { emptyTextClassName: _.emptyText };
      function D(e) {
        const { exchanges: t } = e,
          {
            selectedExchange: n,
          ...
          p =
            Object(S.a)({ watchedValue: T.watchedTheme }) === j.a.Dark ? R : M,
          ...
          O = Object(r.useMemo)(() => [[...t]], [t]),
          k = Object(r.useMemo)(() => {
            const e = O.filter((e) => e.some(x));
            return e;
          }, [O, x]),
          N = Object(f.ensureNotNull)(n).value,
          D = Object(r.useRef)(null),
          A = Object(r.useRef)(null);
        Object(r.useLayoutEffect)(() => {
          var e;
          d &&
            (null === (e = null == D ? void 0 : D.current) ||
              void 0 === e ||
              e.focus());
        }, []);
        const z = u
        ...
        const { state: n, update: o } = e,
          {
            ...
            forceUpdate: s,
            upperCaseEnabled: u,
          } = Object(f.ensureNotNull)(Object(r.useContext)(b.a)),
          p = Object(i.b)(
            null === (t = c.current) || void 0 === t ? void 0 : t.value
          ),
          m = Object(l.h)(p);
        let h = [
          { icon: ne, insert: "/", type: "binaryOp", name: "division" },
          { icon: re, insert: "-", type: "binaryOp", name: "subtraction" },
          { icon: ae, insert: "+", type: "binaryOp", name: "addition" },
          { icon: oe, insert: "*", type: "binaryOp", name: "multiplication" },
        ];
        return (
            ...
            (h = h.concat([
              {
                ...
                callback: () => {
                  !c.current ||
                    m.errors.length ||
                    m.warnings.length ||
                    ((c.current.value = Object(l.g)(Object(l.a)(p))), s());
                },
              },
            ])),
          a.a.createElement(
                  ...
                  (function (e) {
                    ...
                    if (!ue(e, m)) {
                      if (e.insert && c.current) {
                        ...
                        (c.current.value = t),
                          c.current.setSelectionRange(t.length, t.length);
                        const [r, , a] = Object(l.b)(c.current, u);
                        n.current &&
                          ((n.current.selectedIndexValue = -1),
                          (n.current.searchSpreadsValue = Object(l.e)(a)),
                      ...
                      e.callback && e.callback(),
                        ...
                        Object(J.trackEvent)("GUI", "SS", e.name);
                    }
                  })(e),
              })
            )
      ...
      function fe(e) {
        ...
        return a.a.createElement(
          ...
          a.a.createElement("span", { className: c()(pe.content, s) }, i)
        );
      }
      var he = n("UEVQ");
      function be(e) {
      ...
      function ke(e) {
        const {
          ...
          d = Object(f.ensureNotNull)(l),
          p = "symbolSearch" === t,
          m = Object(g.g)(d),
          { country: v, providerId: y, flag: E } = d;
        return p
          ? a.a.createElement(
              "div",
              {
              ...
              !!m && a.a.createElement(h.a, { className: Oe.icon, icon: k }),
              a.a.createElement(
                "div",
                { className: Oe.title },
                m ? Object(s.t)("All sources") : d.name
              ),
              a.a.createElement(xe.a, { className: Oe.caret, dropped: !1 })
            )
          : null;
      }
      var Ne = n("2gjO");
      const we = Object(g.c)();
      function Se(e) {
        const { isSmallWidth: t, selectedExchange: n } = Object(
            f.ensureNotNull
          )(Object(r.useContext)(b.a)),
          o = n && we.length > 1 && !Object(g.a)();
        return a.a.createElement(
          "div",
          ...
          a.a.createElement(
            ...
            a.a.createElement(
              "div",
              { className: Ne.text },
              t ? Object(s.t)("Symbol & description") : Object(s.t)("Symbol")
            )
          ),
          a.a.createElement(
            "div",
      ...
      function je(e) {
        const {
          ...
          { mode: p, isSmallWidth: m, handleListWidth: h } = Object(C.a)(b.a),
          [v, g] = Object(r.useState)(null),
          y = Object(r.useCallback)(
            (e) => {
              const { index: t, style: n } = e;
              return a.a.createElement("div", { style: n }, l[t]);
            },
            [l]
          ),
          E = Object(r.useCallback)((e) => Object(f.ensure)(l[e].key), [l]),
          x = "watchlist" === p && null !== v;
        return a.a.createElement(
          Ee.a,
          {
      ...
      function Me(e) {
        const {
          ...
          k =
            l &&
            a.a.createElement(BrokerCheckbox, {
              brokerTitle: l,
              checked: u,
              onCheckboxChange: d,
            }),
          N = "symbolSearch" === f && "good" === n,
          w = null != x ? x : Ie.a,
          S = Object(r.useMemo)(
            () => E.map((e) => a.a.createElement(w, { ...e, searchToken: t })),
            [E]
          );
        return a.a.createElement(
          a.a.Fragment,
          ...
          "symbolSearch" === f &&
            a.a.createElement(
              ...
              null,
              !1,
              "empty" === n && a.a.createElement(O, null)
            )
        );
      }
      function _e(e) {
      ...
      function Ae(e) {
          ...
          Object(r.useEffect)(() => {
            ...
            if (e)
              return (
                ...
                e.addEventListener("select", he),
                e.addEventListener("click", he),
                e.addEventListener("keyup", xe),
                _ && L && e.addEventListener("keydown", L),
                () => {
                  e &&
                    (e.removeEventListener("input", be),
                    e.removeEventListener("focus", Ee),
                    e.removeEventListener("select", he),
                    e.removeEventListener("click", he),
                    e.removeEventListener("keyup", xe),
                    _ && L && e.removeEventListener("keydown", L));
                }
              );
          }, [L]),
          Object(r.useEffect)(() => {
            (Boolean(T) && "" === F.trim()) ||
              (ge(F, m, null == u ? void 0 : u.value),
              W.current && (W.current.scrollTop = 0));
          }, [F, m, u, oe, T]),
          Object(r.useEffect)(() => {
            if (!k || !y.current) return;
            if (!d.enabled("show_spread_operators"))
              return (y.current.value = k.symbol), void w();
        ...
        return a.a.createElement(
          ...
          !(_ && "symbolSearch" === t) &&
            a.a.createElement(
              ...
              O && a.a.createElement(le, { state: K, update: ve })
            ),
          de
            ...
            : a.a.createElement(Me, {
                ...
                onResetFilters: function () {
                  ...
                  ce(!1),
                    i || null === (e = y.current) || void 0 === e || e.focus();
                },
                brokerTitle: ae,
                isBrokerChecked: oe,
        ...
        function ve() {
          ...
          (H.current = null),
            Object(Q.unstable_batchedUpdates)(() => {
        ...
        async function ge(e, t, n) {
          try {
            ...
            const r = await (async function (e, t, n, r) {
                ...
                const p = d.enabled("show_spread_operators")
                    ? null !==
                        (c =
                          null !== (o = Object(l.c)(t)) && void 0 !== o
                            ? o
                            : i) && void 0 !== c
                      ? c
                      : r
        ...
        function Ee() {
          "watchlist" === D.current &&
            (n("symbolSearch"),
            Object(J.trackEvent)("Watchlist", "Mobile SS", "Go to SS page"));
        }
        function xe(e) {
      ...
      function Be(e) {
        const { theme: t = Pe } = e,
          { setMode: n, isMobile: r } = Object(C.a)(b.a);
      ...
      function Ue(e) {
        ...
        const {
          ...
          L = void 0 !== e.input,
          [A, z] = Object(r.useState)(o),
          P = Object(r.useRef)(c),
          [B, Z] = Ge({ exchanges: Qe, defaultExchange: qe }),
          [V, F] = We({ types: C }),
          [G, W] = Object(r.useState)([]),
          [X, K] = Object(r.useState)(!1),
          ...
          te = Object(Xe.a)(),
          [ne, re] = Object(r.useState)(new Set()),
          {
            broker: ae = null,
            brokerId: oe,
        ...
        Object(r.useLayoutEffect)(() => {
          ...
          !(null == H ? void 0 : H.current) ||
            ...
            (L || "compare" === A || (H.current.value = P.current),
            !I || (L && "symbolSearch" !== A) || H.current.focus());
        }, [A]),
          Object(r.useEffect)(() => {
            (null == H ? void 0 : H.current) && f && I && H.current.select();
          }, []);
        const ie = Object(r.useMemo)(
            () =>
              G.reduce((e, t) => {
                const n = Je(t),
                  r = ne.has(n);
              ...
              ie.map((e, t) => {
                ...
                }
                {
                  ...
                  return {
                    ...
                    isOffset: !0,
                    isEod:
                      null === (a = e.params) || void 0 === a
                        ? void 0
                        : a.includes("eod"),
                    onClick: ye.bind(null, e.parent, e),
                    providerId: n.provider_id,
                    country:
                      null === (o = n.country) || void 0 === o
                        ? void 0
                        : o.toLowerCase(),
                    type: n.type,
          ...
          he =
            "exchange" === A
              ? {
                  ...
                  render: () => a.a.createElement(fe, { exchanges: Qe }),
        ...
        function xe(e) {
          ...
          (H.current.value = t),
            H.current.setSelectionRange(n, n),
            H.current.focus();
        }
        function Oe(e) {
          switch (Object(ee.hashFromEvent)(e)) {
            ...
            case 37: {
              if (-1 === Q) return;
              const t = ue[Q],
                { id: n, isOffset: r, onExpandClick: a } = t;
        ...
        function ke(e) {
          ...
          if (d.enabled("show_spread_operators") && X && t) {
            ...
            if (!Ne(t)) return;
            return (
              h([{ symbol: He ? t.toUpperCase() : t, resolved: !1 }]),
              void (e && n())
            );
          }
      ...
      function tt(e) {
        const { isMobile: t, isTablet: n } = Object(C.a)(b.a);
        return a.a.createElement(m.a, {
          ...e,
          className: c()(
            Ke.dialog,
            !t && (n ? Ke.tabletDialog : Ke.desktopDialog)
          ),
          backdrop: !0,
          draggable: !1,
        });
    ...
    zjoO: function (e, t, n) {
      ...
      function g(e) {
        const {
          ...
          { isSmallWidth: G, isMobile: W } = Object(s.ensureNotNull)(
            Object(r.useContext)(d.a)
          ),
          X = Boolean(M),
          K = !C && !j && (W || !X),
          Q =
            Object(m.a)({ watchedValue: f.watchedTheme }) === p.a.Dark
              ? v.dark
              : v.light,
          q = M;
        return a.a.createElement(
          ...
          a.a.createElement(
            "div",
            { ref: z, className: c()(v.itemInfoCell, v.cell, S && v.offset) },
            a.a.createElement(
              "div",
              {
              ...
              n &&
                a.a.createElement(
                  ...
                  "string" == typeof n && y
                    ...
                    : n,
                  N && a.a.createElement("span", { className: v.dataMode }, "E")
                ),
              !n &&
                t &&
                a.a.createElement(
