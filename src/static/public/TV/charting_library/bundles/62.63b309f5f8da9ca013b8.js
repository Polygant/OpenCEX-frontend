      ...
      class _ {
        constructor(e, t) {
          (this._yCoordinateStepWV = null),
            ...
            (this._source = t),
            (this._undoModel = e),
            (this._ownerSource = Object(s.ensureNotNull)(
        ...
        _createVisibilitiesPropertyPage() {
          ...
          return Object(r.a)(
            Object(u.a)(this._undoModel, e, this._source.title(!0)),
            "visibility",
            l
          );
        }
              ...
              r &&
                i.push(
                  Object(h.c)(
                    ...
                    e,
                    s,
                    Object(n.t)("#{count} (price, bar)", {
                      context: "linetool point",
                    }).format({ count: (o + 1).toString() }),
                    this._source.name()
                  )
                );
            }),
          ...
          const n = Object(s.n)(
            {
              checked: Object(s.b)(
                e,
                t.seconds,
                `Change ${i} Visibility On Seconds`
              ),
        ...
        const C = Object(s.n)(
            {
              checked: Object(s.b)(
                e,
                t.minutes,
                `Change ${i} Visibility On Minutes`
              ),
