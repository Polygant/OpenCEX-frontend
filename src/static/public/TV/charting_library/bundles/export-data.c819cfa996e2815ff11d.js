    ...
    SIoL: function (e, t, s) {
      ...
      function r(e, t = {}) {
        const s = Object.assign({}, d, t),
          ...
          T = m
            .filter((e) => e instanceof a.study_Overlay)
            .map((e) => e.data());
        (s.includeSeries || 0 === T.length) && T.push(f.bars());
        const y = (function (e, t, s, o) {
            const a = Object(i.ensureNotNull)(
                void 0 !== s ? e.indexOf(s, !0) : e.firstIndex()
              ),
              c = Object(i.ensureNotNull)(
                void 0 !== o ? e.indexOf(o, !0) : e.lastIndex()
              );
            let d = c,
              r = a;
            for (const e of t) {
        ...
        for (let e = w; e <= O; ++e) {
          ...
          e.fill(NaN),
            ...
            s.includeDisplayedValues &&
              o.displayedData.push(new Array(x).fill(""));
        }
        if (s.includeTime || s.includeUserTime) {
          ...
          for (let e = w; e <= O; ++e) {
            s.includeTime &&
              (o.data[e - w][0] = Object(i.ensureNotNull)(r.valueAt(e)));
            const n = Object(i.ensureNotNull)(t.indexToUserTime(e));
            if (
              (s.includeUserTime && (o.data[e - w][b] = n.getTime() / 1e3),
              s.includeDisplayedValues)
            ) {
              const t = l.format(n);
              s.includeTime && (o.displayedData[e - w][0] = t),
                s.includeUserTime && (o.displayedData[e - w][b] = t);
            }
          }
        }
        if (s.includeSeries) {
      ...
      function u(e) {
        ...
        for (let a = 0; a < t.plots.length; ++a) {
          ...
          const u = `${d.title}${r}`;
          s.fields.push(f(l, n, u)),
            s.fieldToPlotIndex.push(a + 1),
            s.fieldPlotOffsets.push(e.offset(c.id));
        }
        return s;
      }
      function f(e, t, s) {
