            ...
            h = Object(s.i)(
              {
                checked: Object(s.b)(
                  this._undoModel,
                  o.visible,
                  `Change ${t} base line visibility`
                ),
                color: Object(s.v)(
                  this._undoModel,
                  o.color,
                  e.transparency,
                  `Change ${t} base line color`
                ),
                width: Object(s.b)(
                  this._undoModel,
                  o.linewidth,
                  `Change ${t} base line width`
                ),
                style: Object(s.b)(
                  this._undoModel,
                  o.linestyle,
                  `Change ${t} base line style`
                ),
              },
            ...
            p = Object(s.i)(
              {
                checked: Object(s.b)(
                  this._undoModel,
                  a.visible,
                  `Change ${t} up line visibility`
                ),
                color: Object(s.v)(
                  this._undoModel,
                  a.color,
                  e.transparency,
                  `Change ${t} up line color`
                ),
                width: Object(s.b)(
                  this._undoModel,
                  a.linewidth,
                  `Change ${t} up line width`
                ),
                style: Object(s.b)(
                  this._undoModel,
                  a.linestyle,
                  `Change ${t} up line style`
                ),
              },
              { id: i + "UpLine", title: r }
            ),
            ...
            Object(s.i)(
              {
                checked: Object(s.b)(
                  this._undoModel,
                  y.visible,
                  `Change ${t} down line visibility`
                ),
                color: Object(s.v)(
                  this._undoModel,
                  y.color,
                  e.transparency,
                  `Change ${t} down line color`
                ),
                width: Object(s.b)(
                  this._undoModel,
                  y.linewidth,
                  `Change ${t} down line width`
                ),
                style: Object(s.b)(
                  this._undoModel,
                  y.linestyle,
                  `Change ${t} down line style`
                ),
              },
    ...
    WUYT: function (e, t, i) {
      ...
      class P extends class {
        ...
        _createVisibilitiesPropertyPage() {
          ...
          return Object(l.a)(
            Object(y.a)(this._undoModel, e, this._source.title(!0)),
            "visibility",
            f
          );
        }
        ...
        _inputsPropertyDefinitions() {
          ...
          return (
            null !== this._sourceInput &&
              (this._inputSourceItems = new d.a(this._getInputSourceItems())),
        ...
        _getInputSourceItems() {
          ...
          if (
            ...
            (this._source.isChildStudy() ||
              a.a.canBeChild(this._source.metaInfo()))
          ) {
              ...
              .forEach((t) => {
                ...
                if (1 === r.length) e.push({ id: o, value: o, title: i });
                  ...
                  const t = r.reduce((e, t, n) => {
                    ...
                    let r;
                    try {
                      r = Object(s.ensureDefined)(
                        Object(s.ensureDefined)(l)[t.id]
                      ).title;
                    } catch (e) {
                      r = t.id;
                    }
          ...
          if ("resolution" === h.type)
            p = Object(o.k)(
              { option: Object(o.b)(e, i[h.id], "Change " + t) },
              {
                id: "StudyInput" + t,
                title: a,
                options: new l.a(r.resolutionItems),
              }
            );
            ...
            p = Object(o.o)(
              { session: Object(o.b)(e, i[h.id], "Change " + t) },
              { id: "StudyInput" + t, title: a }
            );
          else if ("bool" === h.type)
            p = Object(o.c)(
              { checked: Object(o.b)(e, i[h.id], "Change " + a) },
              { id: "StudyInput" + t, title: a }
            );
          else if (
            "integer" === h.type ||
            ...
            h.min && (s.min = new l.a(h.min)),
              ...
              void 0 !== h.step &&
                isFinite(h.step) &&
                h.step > 0 &&
                (s.step = new l.a(h.step)),
              (p = Object(o.j)(
                { value: Object(o.b)(e, i[h.id], "Change " + a) },
                s
              ));
          } else
            p = Object(o.q)(
