    ...
    zqjM: function (e, i, t) {
              ...
              if ("float" === t.type) {
                ...
                return (
                  (o =
                    (function (e, i) {
                      return !(
                        ((i === Object(l.chartStyleStudyId)(4) ||
                          i === Object(l.chartStyleStudyId)(6)) &&
                          "boxSize" === e) ||
                        (i === Object(l.chartStyleStudyId)(5) &&
                          "reversalAmount" === e)
                      );
                    })(p, i) || null === a.value()
                      ? new s.a(t.min)
      ...
      const w = Object(b.getLogger)("Chart.Definitions.Series"),
        y =
          ...
          window.t("Session"),
          window.t("Pre/Post market hours background")),
