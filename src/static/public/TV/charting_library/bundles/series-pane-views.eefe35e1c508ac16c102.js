          ...
          if (null !== this._data) {
            ...
            if (
              ...
              var p = m + 8 + (i - r) / 2,
                v = d(t, r);
              if (
                (t.fillText(this._data.dateString, p + v, u + e + 8),
        ...
        updateImpl() {
          ...
          if (
            ...
            if (null != s) {
              ...
              if (((this._point = new a(d, r)), this._gotoDateResult.eod))
                this._eod = !0;
              else {
                var o = this._series.model().timeScale().indexToUserTime(t);
                (this._dateString = new n().format(o)),
                  this._series.isDWM() ||
                    (this._timeString = new l().format(o));
              }
            }
          }
        }
