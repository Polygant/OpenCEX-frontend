    ...
    "5f7t": function (e, t, o) {
      ...
      const S = [
        ...
        },
        {
          ...
          items: [
            ...
            Object(f.isFeatureEnabled)("remove-line-tool-ghost-feed")
              ? null
            ...
            n.a.createElement(
              ...
              o &&
                n.a.createElement("div", {
                  className: c()(O.fadeTop, { [O.isVisible]: h && l > r }),
                }),
              o &&
                n.a.createElement("div", {
                  className: c()(O.fadeBot, { [O.isVisible]: d && l > r }),
                }),
              i &&
                n.a.createElement(
                  "div",
                  {
                    className: c()(O.scrollTop, { [O.isVisible]: h && l > r }),
              ...
              i &&
                n.a.createElement(
                  "div",
                  {
                    className: c()(O.scrollBot, { [O.isVisible]: d && l > r }),
        ...
        constructor(e) {
          super(e),
            ...
            (this._handleSelect = (e) => {
              Object(W.saveDefaults)("linetoolicon", {
                ...Object(W.defaults)("linetoolicon"),
                icon: e,
              }),
            ...
            i.createElement(
              ...
              o.map((o, n) => {
                ...
                return i.createElement(ee.b, {
                  ...
                  shortcut:
                    !s && o.hotkeyHash
                      ? Object(C.humanReadableHash)(o.hotkeyHash)
                      : void 0,
                  icon: d.icon,
                  isActive: r && a === n,
                  appearAsDisabled: u,
      ...
      function de(e) {
        const {
          ...
          [a, r] = Object(i.useState)(() =>
            h.getValue("ChartToolsHideMode", "drawings")
          ),
          ...
          z,
          {
            buttonIcon: (function () {
              switch (a) {
                case "drawings":
                  return c
                    ? ce.a.hideAllDrawingToolsActive
                    : ce.a.hideAllDrawingTools;
                case "indicators":
                  return u
                    ? ce.a.hideAllIndicatorsActive
                    : ce.a.hideAllIndicators;
                default:
                  return c && u
                    ? ce.a.hideAllDrawingsActive
                    : ce.a.hideAllDrawings;
              }
            })(),
          ...
          n.a.createElement(ee.b, {
            ...
            onClick: function () {
              ...
              t.setValue(e),
                o.setValue(e),
                _("all"),
                ue("hide drawings and indicators", e);
            },
      ...
      class ge extends i.PureComponent {
        ...
        componentDidMount() {
          const e = (this._promise = Object(a.ensureNotNull)(
            Object(me.getFavoriteDrawingToolbarPromise)()
          ));
          e.then((t) => {
            this._promise === e &&
              ((this._instance = t),
      ...
      class He extends i.PureComponent {
          ...
          super(e),
            ...
            (this._filteredLineTools = S.map((e) => ({
              ...
              items: e.items.filter((e) =>
                this._toolsFilter.isToolEnabled(w.a[e.name].localizedName)
              ),
        ...
        render() {
          ...
          const p = () =>
            !!this._features.tools && !!u.enabled("show_object_tree");
          return i.createElement(
            Ve.a,
      ...
      class Ke {
        constructor(e, t) {
          (this._component = null),
            ...
            (this._container = e),
            s.render(
              i.createElement(He, { ...t, ref: this._handleRef }),
              this._container
            );
        }
        destroy() {
          ...
          Object(i.useEffect)(() => {
            ...
            return (
              ...
              () => {
                ...
                h.CheckMobile.iOS() && Object(l.enableBodyScroll)(e),
                  0 === t && Object(r.a)(!1);
              }
            );
          }, []),
