  ...
  ["study-pane-views"],
  {
      ...
      class u extends h.ScaledPaneRenderer {
        constructor(t) {
          super(),
            ...
            (this._points = []),
            (this._hittest =
              t || new l.HitTestResult(l.HitTestResult.MOVEPOINT));
        }
        setData(t) {
        ...
        hitTest(t) {
          if (
            ...
            return null;
          const e = Math.max(
              Object(d.interactionTolerance)().line,
              Math.ceil(this._data.linewidth / 2)
            ),
            i = this._points.length;
          if (1 === i) {
            return Object(s.pointInCircle)(t, this._points[0], e)
              ? this._hittest
              : null;
          }
          for (let s = 1; s < i; s++) {
            const i = this._points[s - 1],
              r = this._points[s];
            if (Object(n.distanceToSegment)(i, r, t).distance <= e)
              return this._hittest;
          }
          if (this._data.filled && this._data.fillBackground && i > 0) {
            const s = this._points[0],
              r = this._points[i - 1];
            if (Object(n.distanceToSegment)(s, r, t).distance <= e)
              return this._hittest;
          }
          return this._data.filled &&
            this._data.fillBackground &&
            Object(s.pointInPolygon)(t, this._data.points)
            ? this._backHittest
            : null;
        }
        _drawImpl(t, e) {
          ...
          if (
            (this._data.filled &&
              this._data.fillBackground &&
              ((t.fillStyle = Object(c.generateColor)(
                ...
                const f = i.points.map((i) => {
                  const r = e.indexToCoordinate(i.index + (i.offset || 0)),
                    o = t.priceToCoordinate(
                      Object(s.ensureDefined)(i.level),
                      a
                    );
    ...
    Gj0v: function (t, e, i) {
        ...
        hitTest(t, e) {
          ...
          for (const s of i.histograms) {
            ...
            for (const l of s.bars) {
              ...
              r += l.height;
              const g = Math.max(
                (c.percentWidth * o) / 100 - l.subBarValues.length,
                0
              );
            ...
            i.histograms.forEach((s) => {
              ...
              const c = o / s.bars.length,
                h =
                  ((d = c),
                  (u = e.pixelRatio),
                  Math.floor(d * u) >= 1 * u ? Math.floor(u) : 0);
              var d, u;
              const _ = f(s.xRange),
                b = [];
              if (
                (s.bars.forEach((o) => {
                  ...
                  for (let i = 0; i < o.subBarValues.length; i++) {
                    const s = f.min,
                      n = f.max,
                      r =
                        0 === i ? d : d + u * ((R * o.subBarValues[i - 1]) / a),
      ...
      class y {
        ...
        _prepareStyles() {
          const t = Object(s.ensureDefined)(
              ...
              n < l ||
                ...
                this._data.push({
                  ...
                  top: i.extendTop
                    ? void 0
                    : t.priceToCoordinate(
                        Object(s.ensureDefined)(i.endPrice),
                        o
                      ),
                  bottom: i.extendBottom
                    ? void 0
                    : t.priceToCoordinate(
                        Object(s.ensureDefined)(i.startPrice),
                        o
                      ),
                  color: h.color.value(),
