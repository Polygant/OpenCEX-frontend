  ...
  ["floating-toolbars"],
  {
    ...
    "0ZwQ": function (t, e, i) {
      ...
      class m {
        constructor(t) {
          ...
          (this._helper = null),
            ...
            (this._handleDragMove = (t) => {
              var e;
              if (null === this._helper || this._helper.pointer !== t.pointerId)
                return;
              const i = this._source,
                o = this._helper.nextTop,
                n = this._helper.nextLeft,
                s =
                  "y" === this._axis || !1 === this._axis || 0 !== t.movementY;
              if (s) {
                const e = this._helper.startTop;
                isFinite(e) &&
                  (this._helper.nextTop = t.clientY - this._helper.startY + e);
              }
              const r =
                "x" === this._axis || !1 === this._axis || 0 !== t.movementX;
              if (r) {
                const e = this._helper.startLeft;
                isFinite(e) &&
                  (this._helper.nextLeft = t.clientX - this._helper.startX + e);
              }
          ...
          const n = (this._handle =
            null !== (e = t.handle ? o.querySelector(t.handle) : null) &&
            void 0 !== e
              ? e
              : o);
        ...
        _getEventTarget() {
          return _.CheckMobile.iOS() || (Object(_.isMac)() && o.touch)
      ...
      class C {
        ...
        addWidget(t, e = {}) {
          ...
          (o.className = "tv-floating-toolbar__widget js-widget"),
            o.appendChild(t);
          const n =
        ...
        _savePosition() {
          ...
          if ("device" === this._options.positionStorageType)
            ...
            Object(s.setJSON)(this._options.positionSettingsKey, {
              left: t.left,
              top: t.top,
            });
        }
        ...
        _initSortable() {
          ...
          lazyJqueryUI(this._content).sortable({
            ...
            stop: (e, i) => {
              ...
              t !== o &&
                (Object(v.trackEvent)("Floating Toolbar", "User Sort"),
                this._reorderedDelegate.fire(t, o));
            },
            tolerance: "pointer",
            distance: 5,
        ...
        return n.a.createElement(
          ...
          n.a.createElement(u.a, {
            ...
            onColorChange: function (t, e) {
              const i = w
                ? Object(d.alphaToTransparency)(Object(c.parseRgba)(w)[3])
                : 0;
              L(Object(d["generateColor"])(String(t), i, true)),
                e || Object(a.ensureNotNull)(f.current).close();
            },
            onOpacityChange: function (t) {
              L(
                Object(d.generateColor)(w, Object(d.alphaToTransparency)(t), !0)
              );
            },
    ...
    Ve4Q: function (t, e, i) {
          ...
          onClick: function () {
            Object(P.trackEvent)(
              ...
              i.showChartPropertiesForSource(
                i.model().selection().lineDataSources()[0],
                void 0,
                { onWidget: i.onWidget() }
              );
          },
      ...
      function R(t) {
        ...
        return n.a.createElement(V, {
          ...
          isActive: Boolean(s),
          onClick: function () {
            Object(P.trackEvent)("GUI", "Context action on drawings", "Lock"),
      ...
      function j(t) {
        ...
        return n.a.createElement(S.a, {
          ...
          "data-name": "remove",
          onClick: function () {
            Object(P.trackEvent)("GUI", "Context action on drawings", "Remove"),
              i.removeSelectedSources();
          },
        });
      }
      var F = i("Iivm"),
                ...
                : function () {
                    const t = [
                      ...
                      e = (function () {
                        ...
                        o.length > 0 &&
                          t.push(
                            new G.Action({
                              ...
                              icon: i("+KIV"),
                              shortcutHint:
                                D.humanReadableModifiers(z.Modifiers.Mod) +
                                e +
                                " Drag",
                        ...
                        if (n.length > 0) {
                          const i = {
                            ...
                            shortcutHint:
                              ...
                              " C",
                            onExecute: () => {
                              s.chartWidgetCollection().clipboard.uiRequestCopy(
                                n
                              );
                            },
                          };
                        ...
                        if (
                          !(function () {
                            if (!(null == s ? void 0 : s.isMultipleLayout()))
                              return !1;
                ...
                ? function (t) {
                    g.contextMenuActionsForSources(d).then((e) => {
                      window.matchMedia(C.a.TabletSmall).matches
                        ? q.ContextMenuManager.createMenu(J(e), {
                            mode: "drawer",
                            "data-name": "more-menu",
                          }).then((e) => e.show(t))
                        : u(J(e));
      ...
      function J(t) {
        return A.touch && !window.matchMedia("(pointer:fine)").matches
          ? t.filter((t) => "Copy" !== t.id)
          : t;
      }
      var tt = i("972a"),
        et = i("bQEj"),
      ...
      class dt extends y.b {
        ...
        setGroupedWidgetState(t, e) {
          const i = this._ensuredGetWidgetDataForId(t);
          Object(_.assert)(
            -1 !== dt._getStateIndexById(i.statedWidget, e),
            `Unknown stateId (${e})`
          ),
        ...
        _createSubWidget(t, e) {
          ...
          return (
            ...
            t.statedWidget.stateWidgetAddClass &&
              i.classList.add(t.statedWidget.stateWidgetAddClass),
      ...
      class pt {
        ...
        _unmountToolbar() {
          null !== this._container &&
            (r.a.unmountComponentAtNode(this._container),
            (this._toolbarRendered = !1));
        }
        ...
        _prepareProperties(t) {
          const e = this.selectedSources().filter(
            (e) => Object(u.isLineTool)(e) && e.properties()[t]
          );
    ...
    gmn6: function (t, e, i) {
      ...
      class g extends o.b {
        ...
        hide() {
          h.setValue("ChartFavoriteDrawingToolbarWidget.visible", !1),
            super.hide();
        }
        canBeShown() {
        ...
        _attachHandlers() {
          n.a.favoriteAdded.subscribe(this, this._onFavoriteAdded),
            ...
            this.onWidgetsReordered().subscribe(this, (t, e) => {
              if (
                (n.a.favoriteMoved.unsubscribe(this, this._onFavoriteMoved),
                !n.a.moveFavorite(n.a.favorite(t), e))
              )
            ...
            this.onContextMenu((t) => {
              t.preventDefault(),
                l.ContextMenuManager.createMenu([this._hideAction]).then(
                  (e) => {
                    e.show(t);
                  }
                );
        ...
        _loadVisibilityState() {
          ...
          h.getBool("ChartFavoriteDrawingToolbarWidget.visible", !0) && t
            ? this.show()
            : this.hide();
        }
      }
      ...
      class g extends s {
        ...
        onToolChanged(t, e) {
          ...
          this._isDrawingToolExcludingTweet(t)
            ...
            : i && i.length
            ? (i.length > 1 && this._isDrawingFinished.setValue(!0),
        ...
        _getPossibleProperty(t) {
          for (
            var e = [], i = this._defaultToolProperties(), o = 0;
            o < i.length;
            o++
          ) {
            var n = i[o];
        ...
        showPropertiesOf(t, e, i) {
          ...
          if (
            (this._clearProperties(), (this._propertiesVisible = !1), o.length)
          ) {
            for (var n = {}, s = 0; s < o.length; s++) {
              for (
                var r = o[s], a = e, c = r.name.split("."), d = 0;
                d < c.length;
                ++d
              )
                a = a && a[c[d]];
        ...
        _createToolExceptionCases() {
          return {
            ...
            LineToolRiskRewardShort:
              g.prototype._riskPropertiesExceptionCases(),
            LineToolBarsPattern: [
              {
                name: "color",
                title: p,
