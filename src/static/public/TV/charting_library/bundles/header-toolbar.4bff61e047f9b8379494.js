(window.webpackJsonp = window.webpackJsonp || []).push([
  ["header-toolbar"],
  {
    ...
    KMbc: function (e, t, a) {
      ...
      class se {
        ...
        favId(e) {
          return Object(J.isPineIdString)(e)
            ? e
            : Object(J.extractPineId)(e) || Object(Z.extractStudyId)(e);
        }
        favorites() {
      ...
      function he(e = []) {
        return Object(z.mergeResolutions)(
          e,
      ...
      class be extends s.PureComponent {
        constructor(e) {
          ...
          (this._showScrollbarWhen = Object(i.ensureDefined)(
            e.allowedModes
          ).slice(-1)),
        ...
        componentDidUpdate(e, t) {
          ...
          a !== t.isVisible &&
            (u.emit("toggle_header", a), this._negotiateResizer()),
          ...
          return s.createElement(
            ...
            s.createElement(
              ...
              s.createElement(
                "div",
                {
                  className: r(pe.toolbar, { [pe.isHidden]: !o }),
      ...
      class ge {
        constructor(e, t) {
          (this._component = null),
            ...
            (this._container = e),
            n.render(
              s.createElement(be, { ...t, ref: this._handleRef }),
              this._container
            );
        }
        destroy() {
