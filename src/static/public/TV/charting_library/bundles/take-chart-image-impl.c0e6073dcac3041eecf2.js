  ...
  ["take-chart-image-impl"],
  {
    "13es": function (t, e, n) {
        ...
        return new Promise((n, a) => {
          !(async function (t, e, n, a = {}) {
            ...
            if (void 0 !== a.previews)
              for (const t of a.previews) r.append("previews[]", t);
            ...
            "exchange" === p &&
              (p =
                (null === (i = s.model().mainSeries().symbolInfo()) ||
                void 0 === i
                  ? void 0
                  : i.timezone) || p);
            if ((r.append("timezone", p), a.sendClientImage)) {
              ...
              r.append(
                "images",
                JSON.stringify(t.images(), (t, e) =>
                  e instanceof HTMLCanvasElement ? null : e
                )
              );
            !(async function (t, e, n, a = {}) {
              const i = o.enabled("charting_library_base")
                ...
                : "/snapshot/";
              try {
                const a = await Object(d.fetch)(i, {
                    body: t,
                    method: "POST",
      ...
      async function m(t, e) {
        const n = p(t, e),
          a = n.then((t) =>
            o.enabled("charting_library_base") && e.snapshotUrl
              ? t
              : Object(l.a)(t)
          ),
      ...
      async function g(t) {
        ...
        try {
          ...
          throw (
            (n &&
              n.document.write(
                `<img width="100%" src="${(await e).toDataURL()}"/>`
              ),
            t)
          );
        }
