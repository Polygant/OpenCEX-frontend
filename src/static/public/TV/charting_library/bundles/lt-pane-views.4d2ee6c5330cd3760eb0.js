(window.webpackJsonp = window.webpackJsonp || []).push([
  ["lt-pane-views"],
  {
              ...
              : ((s = Object(r.distanceToSegment)(l, t, e)),
                s.distance <= o
                  ...
                  : this._data.fillBackground &&
                    Object(n.pointInTriangle)(e, t, i, l)
    ...
    "0s1X": function (e, t, i) {
      ...
      class w {
        ...
        hitTest(e) {
          ...
          return Object(h.distanceToSegment)(t.points[0], t.points[1], e)
            .distance <= i
            ? this._hittest
          ...
          if (
            ...
            h =
              "left" === l
                ...
                : "right" === l
                ? a.clone()
                : new n.Point((e.x + r.x) / 2, (e.y + r.y) / 2);
        ...
        _updateImpl() {
          if (
            ...
            a.dotProduct(l) < 0 && (d = 2 * Math.PI - d),
              (this._edge2 = d),
              h < d &&
                ((this._edge1 = Math.max(h, d)),
                (this._edge2 = Math.min(h, d) + 2 * Math.PI)),
              Math.abs(h - d) > Math.PI &&
                ((this._edge1 = Math.min(h, d)),
                (this._edge2 = Math.max(h, d) - 2 * Math.PI));
            for (
        ...
        _updateRenderer() {
          if (!((x = this._points).length < 2)) {
            ...
            for (var p = this._levels.length - 1; p >= 0; p--) {
              ...
              if (
                (v.setData(g),
                v.setHitTest(new a(a.MOVEPOINT, null, f.index)),
                e.append(v),
                t.showCoeffs.value())
              ) {
                var w = new s(this, p);
      ...
      class d {
        ...
        hitTest(e) {
          ...
          return Math.abs(e.y - this._data.points[0].y) <= t
            ? new s(this._data.hitTestResult)
            : null;
        }
      }
        ...
        _updateImpl() {
          ...
          if (
            ...
            if ("right" === n) {
              ...
              "center" === n &&
                (o.x = (o.x + this._model.timeScale().width()) / 2);
            var g = {
              points: [o],
              text: h,
    ...
    "2trc": function (e, t, i) {
      ...
      class c extends d.ScaledPaneRenderer {
        ...
        _visiblePolygon(e) {
          ...
          if (
            ...
            (Object(a.distanceToLine)(i, s, o).distance < 1e-6 &&
              Object(a.distanceToLine)(i, s, l).distance < 1e-6)
          )
            return null;
      ...
      function u(e, t, i, r) {
        const s = Object(n.equalPoints)(i, r[0])
          ? Object(n.equalPoints)(i, r[1])
            ? null
            : r[1]
          : r[0];
        return null !== e && null !== s
          ? Object(o.intersectPolygonAndHalfplane)(
              e,
              Object(n.halfplaneThroughPoint)(
                Object(n.lineThroughPoints)(t, i),
                s
              )
            )
          : null;
      ...
      class v extends a.LineSourcePaneView {
        ...
        _updateImpl(e, t) {
          ...
          this._distancePriceRenderer.setData({
            ...
            leftend: u.LineEnd.Normal,
            rightend:
              Math.abs(m.x - y.x) >= 15 * i.linewidth.value()
                ? u.LineEnd.Arrow
                : u.LineEnd.Normal,
          }),
          ...
          if (S && P) {
            ...
            L =
              ", " +
              Object(s.startWithLTR)(new _.TimeSpanFormatter().format(e));
          }
          const C = this._source.volume(),
            ...
            O = {
              text:
                f.format({ count: Object(s.forceLTRStr)(T.toString()) }) +
                L +
                M,
              color: i.textcolor.value(),
              font: i.font.value(),
          ...
          i.fillLabelBackground.value() &&
            (O.backgroundColor = i.labelBackgroundColor.value()),
        ...
        _updateImpl(e, t) {
          ...
          if (3 === this._source.points().length) {
            ...
            i.extendLeft.value() &&
              ...
              i.extendRight.value() &&
                (s = this._extendSegmentRight(o, a, d, t, e));
          }
    ...
    "5/lF": function (e, t, i) {
      ...
      class g {
          ...
          if (this._rect) {
            if (
              ...
              for (const s of this._data.icons) {
                ...
                this._drawIcon(e, l, h, s, Boolean(this._data.isDark), t),
                  (n += 1);
              }
            }
          } else
        ...
        _preRender() {
          ...
          const e = (function () {
              if (null !== _) return _;
              const e = Object(c.createDisconnectedCanvas)(
                document,
                new c.Size(0, 0)
              );
      ...
      class _ extends u.LineSourcePaneView {
        ...
        _updateImpl() {
          ...
          if (this._points.length >= 4) {
            this._bcRetracementTrend.setData(a(l, d)),
      ...
      t.TrendBasedFibExtensionPaneView = class extends c {
        ...
        getCacheRects(e, t) {
          ...
          if (i) {
            var n = this._points[1],
              ...
              a = Math.min(n.x, s.x),
              o = Math.max(n.x, s.x);
            (n = new r(a, this._levels[t].y)),
              (s = new r(o, this._levels[t].y));
            var l,
            ...
            switch (h.horzLabelsAlign.value()) {
              case "left":
                ...
                break;
              case "center":
                ((l = n.add(s).scaled(0.5)).x += i.width / 2),
                  (l.x = Math.round(l.x));
                break;
              case "right":
                h.extendLines.value()
        ...
        _updateImpl() {
          if (
            ...
            if (x)
              (p = e.priceToCoordinate(g, t) - e.priceToCoordinate(v, t)),
                (f = e.priceToCoordinate(u.price, t));
            for (
          ...
          if (!(this._points.length < 2)) {
            ...
            for (R = 0; R < this._levels.length; R++) {
              I = {
                points: [
                  (i = new r(V, this._levels[R].y)),
                  (c = new r(H, this._levels[R].y)),
                ],
                width: this._model.timeScale().width(),
                height: this._source.priceScale().height(),
    ...
    "8GeE": function (e, t, i) {
      ...
      class g extends d.LineSourcePaneView {
        ...
        _updateImpl() {
          ...
          (g = Object(n.transformPoint)(w, g)),
            (v = Object(n.transformPoint)(w, v));
          const x = _.add(g);
          x.data = 0;
          ...
          e.append(
            this.createLineAnchor(
              { points: [x, m, y, b], pointsCursorType: T },
              0
            )
          ),
            (this._renderer = e);
      ...
      t.ParallelChannelPaneView = class extends r {
        ...
        _updateImpl() {
          if (
            ...
            var f = [];
            if (
              (this._points[0] && f.push(this._points[0]),
              this._points[1] && f.push(this._points[1]),
              this._p3)
            ) {
              var g = this._p3;
              (g.data = 2), f.push(g);
            ...
            this._model.lineBeingCreated() !== this._source ||
              ...
              (f.pop(), f.pop()),
              p.append(
                this.createLineAnchor({ points: f, pointsCursorType: o }, 0)
              ),
              (this._renderer = p);
          }
        }
      ...
      class P extends y {
        ...
        drawTargetLabel(e) {
          ...
          this._targetRectLeftOffset = Math.max(
            20,
            Math.min(this._targetWidth - 15, b)
          );
          ...
          this._data.clockWhite &&
            e.drawImage(this._data.clockWhite, S + c + _ + N, I + 1);
          var D = v(e, L - c - p);
                ...
                : (x(
                  ...
                  E &&
                    e.drawImage(
                      E,
                      T.x + V - E.width - 4,
                      T.y + this._targetHeight + 10 - Math.abs(z - E.height) / 2
                    )),
              e.restore();
          } else e.restore();
        }
      ...
      t.PredictionPaneView = class extends s {
        constructor(e, t) {
          ...
          function n() {
            (r._pendingIcons -= 1),
              0 === r._pendingIcons &&
                r._source.model().updateSource(r._source);
          }
        ...
        _updateImpl() {
          if (
              ...
              (this._targetLine4 = new u().format(h)),
                d ||
                  (this._targetLine4 =
                    this._targetLine4 +
                    "  " +
                    new _(f ? "%h:%m:%s" : "%h:%m").format(h));
              var v = (h.valueOf() - o.valueOf()) / 1e3;
              this._targetLine2 =
                n("in", { context: "dates" }) + " " + T(new p().format(v));
            }
            ...
            w &&
              ...
              d ||
                (this._sourceLine2 =
                  this._sourceLine2 +
                  " " +
                  new _(f ? "%h:%m:%s" : "%h:%m").format(w))),
              (this._direction =
                this._source.direction() === g.Direction.Up ? "up" : "down"),
              (this._finished =
                this._model.lineBeingCreated() !== this._source &&
            ...
            (x.points = this._points),
              ...
              (x.targetBackColor = this._source
                .properties()
                .targetBackColor.value()),
              (x.targetStrokeColor = this._source
                .properties()
                .targetStrokeColor.value()),
              (x.targetTextColor = this._source
                .properties()
                .targetTextColor.value()),
              (x.sourceBackColor = this._source
                .properties()
                .sourceBackColor.value()),
              (x.sourceStrokeColor = this._source
                .properties()
                .sourceStrokeColor.value()),
              (x.sourceTextColor = this._source
                .properties()
                .sourceTextColor.value()),
              (x.successBackground = this._source
                .properties()
                .successBackground.value()),
              (x.successTextColor = this._source
                .properties()
                .successTextColor.value()),
              (x.failureBackground = this._source
                .properties()
                .failureBackground.value()),
              (x.failureTextColor = this._source
                .properties()
                .failureTextColor.value()),
              (x.intermediateBackColor = this._source
                .properties()
                .intermediateBackColor.value()),
              (x.intermediateTextColor = this._source
                .properties()
          ...
          for (var s = [], a = 0; a < n.length; a++) {
            ...
            if ((h = r.measureText(o).width) <= t) s.push(o);
              ...
              for (var l = o.split(/([-)\]},.!?:;])|(\s+)/); l.length; ) {
                ...
                if (d > 0)
                  s.push(l.slice(0, 3 * d - 1).join("")), l.splice(0, 3 * d);
                else {
                  var c = l[0] + (l[1] || ""),
        ...
        _updateImpl() {
          if (
            ...
            if (
              ...
              r.append(this.createLineAnchor({ points: a }, 0)),
              t.wordWrapWidth)
            ) {
              var o = new n(
                s.x + (t.wordWrapWidth >> 1) + d.RoundRadius + d.TextMargins,
                s.y
              );
      ...
      class u extends d.ScaledPaneRenderer {
        ...
        hitTest(e) {
          if (
            ...
            return null;
          const t = Math.max(
              Object(c.interactionTolerance)().line,
              Math.ceil(this._data.linewidth / 2)
            ),
            i = this._points.length;
          if (1 === i) {
            return Object(r.pointInCircle)(e, this._points[0], t)
              ? this._hittest
              : null;
          }
          for (let r = 1; r < i; r++) {
          ...
          return this._data.filled &&
            this._data.fillBackground &&
            Object(r.pointInPolygon)(e, this._data.points)
            ? this._backHittest
            : null;
        }
        _drawImpl(e, t) {
          ...
          (e.lineCap = l),
            ...
            (e.lineWidth = this._data.linewidth),
            (e.lineJoin =
              null !== (r = this._data.linejoin) && void 0 !== r ? r : "miter"),
        ...
        _updateImpl() {
          ...
          if (
            ...
            if ("horizontal" === e.textOrientation.value()) {
              ...
              switch (
                ((t = -Math.PI / 2), (n = 0), e.horzLabelsAlign.value())
              ) {
                case "left":
                  o = "bottom";
                  break;
          ...
          if (1 === this._points.length) {
            ...
            (e.data = 0),
              (e.square = !0),
              i.append(
                this.createLineAnchor({ points: [e], pointsCursorType: h }, 0)
              );
          }
          this._renderer = i;
        }
        ...
        getCacheRects(e, t) {
          ...
          switch (r.horzLabelsAlign.value()) {
            case "left":
              ...
              break;
            case "center":
              ((i = h.add(d).scaled(0.5)).x += s.width / 2),
                (i.x = Math.round(i.x));
              break;
            case "right":
        ...
        _updateImpl() {
          ...
          for (
            ...
            if ((T = t["level" + d]).visible.value()) {
              ...
              b.setData(y),
                e.append(b),
                (t.showCoeffs.value() || t.showPrices.value()) && o(g, v, d);
            }
          }
          var R = null;
          for (d = h; d >= 1; d--) {
    ...
    "Dz+H": function (e, t, i) {
      ...
      class f {
        ...
        _createSource(e, t, i) {
          ...
          const r = Object(o.ensureNotNull)(
      ...
      class g {
        ...
        _drawTooltipOn(e, t) {
          ...
          e.moveTo(m, y),
            v ||
              "top" !== w ||
              (e.lineTo(x - b, y), e.lineTo(x, y - b), e.lineTo(x + b, y)),
            e.lineTo(m + _, y),
            e.lineTo(m + _, y + p),
            v ||
              "bottom" !== w ||
          ...
          Object(c.drawScaled)(e, t.pixelRatio, () => {
            for (let t = 0; t < s.length; t++)
              e.fillText(s[t].replace(/^\s+/, ""), T, S), (S += i.fontSize + u);
          }),
            e.restore();
        }
      }
      ...
      class f {
        ...
        rowHeight(e) {
          const t = Object(r.ensureDefined)(this._rowsToSources.get(e)),
            i = Object(r.ensureDefined)(
              this._sourcesToRow.get(t)
            ).effectiveState;
        ...
        _repaintSource(e, t, i) {
          (i.points[0] = new n.Point(0, 0)),
            ...
            Object(h.drawScaled)(this._ctx, this._params.pixelRatio, () => {
              ...
              const n = new a.TrendLineStatsRenderer(i, { widths: [] }).draw(
                this._ctx,
                this._params
              );
              Object(r.ensureDefined)(this._sourcesToRow.get(e)).width =
                n.width;
            });
        }
        _recreateCanvas() {
    ...
    Fx2Q: function (e, t, i) {
      ...
      class p extends u.LineSourcePaneView {
        ...
        _updateImpl() {
          ...
          if (
            (this._polyLineRenderer.setData(x),
            g.append(this._polyLineRenderer),
            ...
            this._triangleRendererPoints234.setData(u),
              g.append(this._triangleRendererPoints234);
          }
          if (e) {
            const t = w(e, a, o);
            this._intersect1Renderer.setData(t),
              g.append(this._intersect1Renderer);
          }
          if (t) {
            const e = w(c, u, t);
            this._intersect2Renderer.setData(e),
              g.append(this._intersect2Renderer);
          }
          if (this._points.length >= 2) {
    ...
    GW0y: function (e, t, i) {
      ...
      class d extends l.LineSourcePaneView {
        ...
        _addAnchors(e, t, i) {
          ...
          i.append(
            this.createLineAnchor(
              { points: [e, t, n, s, a, o, l, d], pointsCursorType: p },
              0
            )
          );
        }
      ...
      t.ElliottLabelsPaneView = class extends n {
        ...
        _updateImpl() {
          ...
          if (t && !t.isEmpty() && !i.isEmpty()) {
            ...
            if (e.showWave.value())
              for (
                var p = this._source.ownerSource().firstValue(),
                  f = this._source.points(),
                  g = 1;
                g < f.length;
                g++
              ) {
            ...
            for (
              n = u(e.color.value()), g = 0;
              g < this._points.length - I;
              g++, M = -M
            )
              if (!(g < P)) {
        ...
        _updateImpl(e, t) {
          ...
          const i = this._source.properties().childs(),
            a = {
              ...
              backgroundColor: Object(n.generateColor)(
                i.backgroundColor.value(),
                i.transparency.value()
              ),
    ...
    IMGS: function (e, t, i) {
      ...
      t.RegressionTrendPaneView = class extends r {
        ...
        _updateImpl() {
          ...
          (this._lines = e.lines),
            (this._pearsons = e.pearsons),
            (this._renderer = null);
          for (
            var t = new d(),
              i = [],
              r = [this._lines[1], this._lines[0], this._lines[2]],
              a = [],
              u = 0;
            u < r.length;
            u++
          ...
          for (u = 1; u < a.length; u++) {
            ...
            (_.points = [
              ...
              (_.backcolor = _.color),
              (_.transparency = this._source
                .properties()
                .styles.transparency.value()),
              (_.skipLines = !0),
              (_.fillBackground = !0),
          ...
          if (
            (this._pearsons &&
              ((this._pearsons.color = c.resetTransparency(
                this._pearsons.color
              )),
            ...
            (g[0].data = 0),
              (g[1].data = 1),
              t.append(this.createLineAnchor({ points: g }, 0));
          }
          this._renderer = t;
        }
      };
      ...
      class u extends c.LineSourcePaneView {
        ...
        _updateImpl() {
          ...
          if (
            ...
            const e = {
              points: [
                Object(r.ensureDefined)(h),
                Object(r.ensureDefined)(c),
                l,
              ],
              color: u.color.value(),
              linewidth: u.linewidth.value(),
    ...
    KDMZ: function (e, t, i) {
        ...
        constructor(e, t, i) {
          (this._ready = !1),
            (this._img = (function (e, t, i) {
              const r = new Image();
              return (
                (r.width = t), (r.height = t), (r.onload = i), (r.src = e), r
              );
            })(e, t, () => {
              (this._ready = !0), i();
            }));
      ...
      class o {
        constructor(e, t) {
          (this._icons = new Map()),
            (this._onAllIconsLoaded = new s.a()),
          ...
          e.forEach((e) => {
            ...
            r.set(e.theme, new a(e.imageData, t, i)),
              this._icons.set(e.name, r);
          });
        }
        getIcon(e, t) {
          return Object(r.ensureDefined)(
            Object(r.ensureDefined)(this._icons.get(e)).get(t)
          );
        }
        onAllIconsReady() {
    ...
    KFbh: function (e, t, i) {
      ...
      const x = [
          {
            name: "twitter",
            theme: "",
            imageData: URL.createObjectURL(
              new Blob([w], { type: "image/svg+xml" })
            ),
          },
        ],
        m = new v.a(x, 24);
      ...
      function R(e, t, i, r) {
        ...
        return (
          (void 0 !== n && n.width === t) ||
            ((n = (function (e, t, i, r) {
              const n = Object(c.createDisconnectedCanvas)(
                  document,
                  new c.Size(t, t),
                  1
                ),
      ...
      function L(e) {
        return e.inverseAnchorPosition
          ? P(e) - e.poleTailHeight * e.direction
          : P(e) + e.poleTailHeight * e.direction;
      }
      const C = new (class {
        constructor() {
        ...
        getItem(e, t) {
          const i = this._cachedItems.find(
            (i) =>
              i.sourceLabel === e &&
              Object(g.areEqualPaneRenderParams)(t, i.params)
          );
              ...
              if (void 0 !== i) {
                ...
                (e.tapHandler = (e) => {
                  e.preventDefault(),
                    i(
                      s,
                      new r.Point(e.clientX - e.localX, e.clientY - e.localY),
                      a
                    );
                }),
                  (e.clickHandler = (e) => {
        ...
        draw(e, t) {
          ...
          for (const t of this._items) {
            ...
            e.moveTo(i, Math.round(T(t) * n)),
              ...
              0 !== t.poleTailHeight &&
                (e.moveTo(i, Math.round(P(t) * n)),
                e.lineTo(i, Math.round(L(t) * n)));
          }
          e.stroke();
        ...
        _updateImpl(e) {
          ...
          for (const c of this._timeLine.items()) {
            ...
            this._timeLine.isItemHovered(c)
              ? (h = b)
              : this._timeLineItemsRenderer.addItem(b);
          }
      ...
      class E extends A.LineSourcePaneView {
        constructor(e, t) {
          super(e, t),
            ...
            (this._storiesEventsPaneView = new D(
              t,
              e,
      ...
      class f extends h.ScaledPaneRenderer {
        ...
        hitTest(e, t) {
          ...
          if (
            ...
            const e = this._adapter.hasMoveCallback()
              ? d.HitTestResult.MOVEPOINT
              : d.HitTestResult.REGULAR;
        ...
        _drawQuantity(e, t, i, r) {
          ...
          e.fillRect(t + 0.5, i + 0.5, n - 1, s - 1),
            r &&
              e.clip &&
              (e.beginPath(), e.rect(t + 0.5, i - 0.5, n + 1, s + 1), e.clip()),
        ...
        _drawCancelButton(e, t, i, n) {
          ...
          Object(l.drawPoly)(
            e,
            [new r.Point(t + d, i + c), new r.Point(o - d, h - c)],
            !0
          ),
            Object(l.drawPoly)(
              e,
              [new r.Point(o - d, i + c), new r.Point(t + d, h - c)],
              !0
            );
        }
      }
        ...
        _updateImpl(e) {
          if (
            ...
            const t = this._points[0].y,
              i = e - 3.5 - 1,
              n = this._adapter.hasMoveCallback()
                ? d.HitTestResult.MOVEPOINT
                : d.HitTestResult.REGULAR,
              s = [new r.Point(i, t)];
            this._selectionData = {
      ...
      class l extends n.LineSourcePaneView {
        ...
        getCacheCanvas(e) {
          return (
            ...
            Object(r.ensureNotNull)(this._cache).canvas()
          );
        }
        getCacheRects(e, t) {
    ...
    NN6M: function (e, t, i) {
      ...
      class u extends c.ScaledPaneRenderer {
        ...
        _drawImpl(e, t) {
          ...
          const [i, r] = this._data.points;
          if (!isFinite(i.y) || !isFinite(r.y))
            this._extendAndDrawLineSegment(e, i, r, t);
          else if (
            (this._data.skipLines || this._extendAndDrawLineSegment(e, i, r, t),
            ...
            if (
              (this._data.skipLines ||
                ...
                this._extendAndDrawLineSegment(e, n, s, t),
              this._data.fillBackground &&
        ...
        _extendAndClipLineSegment(e, t, i) {
          ...
          return Object(h.extendAndClipLineSegment)(
            e,
            t,
            i.cssWidth,
            i.cssHeight,
      ...
      class h extends l.ScaledPaneRenderer {
        constructor(e, t, i) {
          super(),
            (this._data = e),
            (this._hitTest =
              t || new r.HitTestResult(r.HitTestResult.MOVEPOINT)),
            (this._backgroundHitTest =
              i || new r.HitTestResult(r.HitTestResult.MOVEPOINT_BACKGROUND));
        }
        hitTest(e) {
        ...
        getCacheRects(e, t) {
          ...
          switch (c.horzLabelsAlign.value()) {
            case "left":
              ...
              break;
            case "center":
              ((d = a.add(o).scaled(0.5)).x += s.width / 2),
                (d.x = Math.round(d.x));
              break;
            case "right":
              c.extendLines.value()
                ? (d = new n(u - 4, this._levels[t].y))
                : (((d = new n(u + 4, this._levels[t].y)).x += s.width),
                  (d.x = Math.round(d.x)));
          }
          var p = {
              left: s.left,
            ...
            if (e && !e.isEmpty() && !this._model.timeScale().isEmpty()) {
              ...
              if (null != t) {
                var i = this._source.points()[0],
                  ...
                  u = !1;
                (L = this._source.properties()).reverse &&
                  L.reverse.value() &&
                  (u = L.reverse.value()),
                  (this._levels = []);
                var _,
                ...
                if (w)
                  (_ = e.priceToCoordinate(f, t)),
                    (p = e.priceToCoordinate(g, t) - _);
                for (
                ...
                if (!(this._points.length < 2)) {
                  ...
                  for (b = 0; b < this._levels.length; b++) {
                    var j,
                      V = {
                        points: [
                          (i = new n(E, this._levels[b].y)),
                          (r = new n(z, this._levels[b].y)),
                        ],
                        width: this._model.timeScale().width(),
                        height: this._source.priceScale().height(),
                    ...
                    if (
                      ((j = new a()).setData(V),
                      j.setHitTest(
                        new l(l.MOVEPOINT, null, this._levels[b].index)
                      ),
                      C.append(j),
      ...
      class c extends d.LineSourcePaneView {
        ...
        _updateImpl() {
          ...
          if (this._source.points().length >= 4) {
            ...
            e =
              Math.round(
                100 * Math.abs((r.price - i.price) / (i.price - t.price))
              ) / 100;
          }
          if (this._source.points().length >= 6) {
            ...
            t =
              Math.round(
                100 * Math.abs((r.price - i.price) / (i.price - e.price))
              ) / 100;
          }
          if (this._points.length < 2) return;
          const i = this._source.properties().childs(),
          ...
          if (
            (this._polyLineRenderer.setData(d),
          ...
          if (!(this._points.length < 2)) {
            ...
            for (_ = 0; _ < this._levels.length; _++) {
              if (void 0 !== this._levels[_].text) {
                ...
                switch (
                  ((C =
                    "left" === C ? "right" : "right" === C ? "left" : "center"),
      ...
      class R extends o.LineSourcePaneView {
        ...
        _updateImpl(e, t) {
          ...
          this._distanceLineRenderer.setData({
            ...
            rightend:
              Math.abs(s.x - o.x) >= 25 * i.linewidth.value()
                ? p.LineEnd.Arrow
                : p.LineEnd.Normal,
          }),
          ...
          this._distancePriceRenderer.setData({
            ...
            leftend: p.LineEnd.Normal,
            rightend:
              Math.abs(v.y - R.y) >= 25 * i.linewidth.value()
                ? p.LineEnd.Arrow
                : p.LineEnd.Normal,
          }),
            this._renderer.append(this._distancePriceRenderer);
          ...
          const A =
            Object(r.ensureNotNull)(this._source.ownerSource())
              .formatter()
              .format(P) +
            " (" +
          ...
          this._textRenderer.setPoints([F]),
            this._renderer.append(this._textRenderer),
            this.addAnchors(this._renderer);
        }
      }
      ...
      class g extends a.LineSourcePaneView {
        ...
        _updateImpl(e, t) {
          ...
          this._distanceRenderer.setData({
            ...
            leftend: _.LineEnd.Normal,
            rightend:
              Math.abs(y.y - b.y) >= 15 * i.linewidth.value()
                ? _.LineEnd.Arrow
                : _.LineEnd.Normal,
          }),
        ...
        _updateImpl() {
          ...
          if (((this._label = null), !(this._source.points().length < 2))) {
            ...
            if (
              ...
              o =
                this._source.ownerSource().formatter().format(y) +
                " (" +
                new d().format(100 * b) +
                ") ";
            ...
            if (this._source.properties().showBarsRange.value()) {
              ...
              (l += n("{count} bars").format({ count: x(T) })),
                m.push("barsRange");
            }
            (this._label =
              [x(o), l]
            ...
            if (this._secondPoint && this._points.length > 0) {
              ...
              this._angleLabelRenderer.setData(j),
      ...
      class _ extends s.ScaledPaneRenderer {
        ...
        hitTest(e, t) {
          ...
          if (4 === i.points.length) {
            ...
            if (
              Object(o.c)(s, r, d, e, t) ||
              Object(o.a)(s, l, _, f, e, t) ||
              Object(o.c)(l, n, g, e, t)
            )
              return new a.HitTestResult(a.HitTestResult.MOVEPOINT);
            let v = Object(c.c)(e, t, i.extendLeftPoints);
            return (
              null === v && (v = Object(c.c)(e, t, i.extendRightPoints)), v
            );
          }
          return null;
        }
          ...
          if (2 === this._data.points.length)
            e.beginPath(),
              ...
              this._data.leftEnd === d.LineEnd.Arrow &&
                Object(h.drawArrow)(r, i, e, e.lineWidth, t.pixelRatio),
              this._data.rightEnd === d.LineEnd.Arrow &&
                Object(h.drawArrow)(i, r, e, e.lineWidth, t.pixelRatio);
          else {
            ...
            this._data.fillBack &&
              ...
              e.stroke(),
              this._data.leftEnd === d.LineEnd.Arrow &&
                Object(h.drawArrow)(o, i, e, e.lineWidth, t.pixelRatio),
              this._data.rightEnd === d.LineEnd.Arrow &&
                Object(h.drawArrow)(p, r, e, e.lineWidth, t.pixelRatio);
          }
        }
      }
      var p = i("Zy3/"),
      ...
      class v extends n.LineSourcePaneView {
        ...
        _updateImpl(e, t) {
          ...
          if (4 === this._source.points().length) {
            const r = this._source.pointToScreenPoint(
                this._source.points()[0]
              )[1],
              a = this._source.pointToScreenPoint(this._source.points()[1])[1],
              o = this._source.pointToScreenPoint(this._source.points()[2])[1],
            ...
            i.extendLeft.value() &&
              (n = this._extendSegmentLeft(o, r, d, t, e)),
              i.extendRight.value() &&
          ...
          null !== o &&
            (a.push(this._source.pointToScreenPoint(o[0])[0]),
            a.push(this._source.pointToScreenPoint(o[1])[0]));
          const l = {
            points: a,
            color: i.linecolor.value(),
            lineWidth: i.linewidth.value(),
            ...
            rightEnd: i.rightEnd.value(),
            fillBack: i.fillBackground.value(),
            backColor: Object(r.generateColor)(
              i.backgroundColor.value(),
              i.transparency.value()
            ),
            extendLeftPoints: n,
          ...
          h.append(this._bezierCubicRenderer),
            this.addAnchors(h),
            (this._renderer = h);
        }
        _extendSegmentLeft(e, t, i, r, n) {
          return (
            Object(f.cacheIsValid)(
              this._extendedSegmentLeftCache,
              e,
              t,
              i,
    ...
    aB9a: function (e, t, i) {
      ...
      function p(e, t, i, r) {
        const n = i + r / 2;
        Object(l.drawRoundRect)(e, t.x - n, t.y - n, 2 * n, 2 * n, (i + r) / 2),
          e.closePath(),
          (e.lineWidth = r);
      }
      function f(e, t, i, r) {
      ...
      class x {
        ...
        draw(e, t) {
          ...
          i.length &&
            ((e.strokeStyle = this._data.color),
            this._drawPoints(e, t.pixelRatio, i, r, g, f)),
            n.length &&
              ((e.strokeStyle = this._data.color),
              this._drawPoints(e, t.pixelRatio, n, s, w, v));
        }
        hitTest(e) {
          if (null === this._data) return null;
        ...
        doesIntersectWithBox(e) {
          return (
            null !== this._data &&
            this._data.points.some((t) => Object(o.pointInBox)(t, e))
          );
        }
        _drawPoints(e, t, i, r, n, s) {
          ...
          for (let c = 0; c < i.length; ++c) {
            ...
            if (
              !(
                Object(h.isInteger)(u.data) && a.linePointBeingEdited === u.data
              )
            ) {
              n(
                e,
      ...
      class y {
        ...
        _lineAnchorColors(e) {
          const t = Object(u.ensureNotNull)(
        ...
        _getLineAnchorRenderer(e) {
          for (; this._lineAnchorRenderers.length <= e; )
            this._lineAnchorRenderers.push(new x());
        ...
        _drawImpl(e) {
          ...
          e.scale(1, i),
            this._data.fillBack &&
              ...
              (e.fillStyle = Object(n.generateColor)(
                this._data.color,
                this._data.transparency,
                !0
              )),
    ...
    bFMU: function (e, t, i) {
      ...
      class u extends c.LineSourcePaneView {
        ...
        _updateImpl() {
          ...
          const u = i(a, "A");
          o.y > a.y
            ? ((u.vertAlign = "bottom"), (u.offsetY = 5))
            : ((u.vertAlign = "top"), (u.offsetY = 5)),
          ...
          if (
            ...
            if (this._pattern && 2 === this._source.points().length) {
              ...
              if (p === u.Bars || p === u.OpenClose) {
                for (
                  var y = new d(),
                    b = p === u.Bars ? ["high", "low"] : ["open", "close"],
                    R = b[0],
                    T = b[1],
                    S = 0;
                ...
                y.append(this.createLineAnchor({ points: this._points }, 0)),
                  (this._renderer = y);
              } else {
                var I;
                y = new d();
    ...
    "cT+B": function (e, t, i) {
            ...
            for (
              ...
              if (f.visible.value()) {
                ...
                var b = {
                  ...
                  R = new s();
                R.setData(b),
                  R.setHitTest(new o(o.MOVEPOINT, null, p)),
                  t.append(R);
                var T = {
                    points: [m, y],
                    width: this._model.timeScale().width(),
                  ...
                  S = new s();
                S.setData(T),
                  S.setHitTest(new o(o.MOVEPOINT, null, p)),
                  t.append(S);
              }
            }
            this.addAnchors(t), (this._renderer = t);
      ...
      (t.PitchforkLinePaneView = d),
        ...
        (t.InsidePitchforkLinePaneView = class extends d {
          constructor(e, t) {
            super(e, t),
              (this._backSideRenderer = new s()),
              (this._centerRenderer = new s());
          }
          _updateRenderer() {
            if (
              (this._floatPoints.length > 1 &&
                ...
                for (var g = 0; g <= 8; g++) {
                  ...
                  if (v.visible.value()) {
                    ...
                    var b = {
                      ...
                      R = new s();
                    R.setData(b),
                      R.setHitTest(new o(o.MOVEPOINT, null, g)),
                      e.append(R);
                    var T,
                      S = {
                        points: [m, y],
                    ...
                    (T = new s()).setData(S),
                      T.setHitTest(new o(o.MOVEPOINT, null, g)),
                      e.append(T);
                  }
                }
                this.addAnchors(e), (this._renderer = e);
        ...
        _updateImpl() {
          ...
          if (1 === this._points.length) {
            ...
            (i.data = 0),
              (i.square = !0),
              t.append(
                this.createLineAnchor({ points: [i], pointsCursorType: d }, 0)
              );
          }
          this._renderer = t;
        }
    ...
    "ct+2": function (e, t, i) {
      ...
      class c {
        ...
        doesIntersectWithBox(e) {
          return (
            null !== this._data && Object(h.pointInBox)(this._data.point, e)
          );
        }
      }
    ...
    d1Pk: function (e, t, i) {
      ...
      function n(e, t, i, n, s, a) {
        if (a)
          return Math.round(
            Object(r.ensureDefined)(e.coordinate) +
              Object(r.ensureDefined)(t.coordinate) * i
          );
            ...
            if (((d.data = 0), i.push(d), 1 !== e.points.length)) {
              ...
              if (((p.data = 1), 2 !== e.points.length)) {
                ...
                (P = h(L, P)),
                  ...
                  (L = o(1, b / (2 * v)));
                var C =
                  (P = h(L, P)).y >= 0 ? new r(f.x, f.y) : new r(y.x, y.y);
                (C.data = 2), i.push(C);
                var M = [g.Default, g.Default, c(s, u)];
                t.append(
                  this.createLineAnchor({ points: i, pointsCursorType: M }, 0)
                );
          ...
          if (
            ...
            this._data.fillBack &&
              ...
              this._data.rightEnd === s.LineEnd.Arrow &&
                Object(h.drawArrow)(l, r, e, e.lineWidth, t.pixelRatio);
          }
        }
      }
    },
      ...
      t.GannSquarePaneView = class extends n {
        ...
        _updateImpl() {
          if (
            ...
            if (
              ((this._hfans = []), (this._vfans = []), L.fans.visible.value())
            )
              for (u = 1; u <= 7; u++) {
                (m = Math.round(w + L["hlevel" + u].coeff.value() * v)),
                  (f = h + L["vlevel" + u].coeff.value() * n);
                this._hfans.push(this._model.timeScale().indexToCoordinate(m)),
                  this._vfans.push(
                    this._source.priceScale().priceToCoordinate(f, c)
                  );
              }
            var b = new l();
            if (this._points.length < 2)
            ...
            for (u = 0; u < this._hlevels.length; u++) {
              ...
              var D = {
                points: [
                  (e = new r(R, this._hlevels[u].y)),
                  (t = new r(S, this._hlevels[u].y)),
                ],
                width: this._model.timeScale().width(),
                height: this._source.priceScale().height(),
            ...
            for (u = 0; u < this._vlevels.length; u++) {
              ...
              if (
                ((z = new o()).setData(D), b.append(z), L.showTopLabels.value())
              ) {
                var j = {
                  points: [e],
        ...
        constructor() {
          super(...arguments),
            ...
            (this._backHitTest = new r.HitTestResult(
              r.HitTestResult.MOVEPOINT_BACKGROUND
            ));
        }
        setData(e) {
          this._data = e;
          ...
          if (
            ...
            for (
              ...
              if (p.visible.value()) {
                ...
                (x = new s()).setData(w),
                  x.setHitTest(new a(a.MOVEPOINT, null, u)),
                  e.append(x);
                var x,
                  m = {
      ...
      t.RotatedRectanglePaneView = class extends s {
        ...
        _updateImpl() {
          if (
            ...
            l.append(
              this.createLineAnchor({ points: m, pointsCursorType: y }, 0)
            ),
              (this._renderer = l);
          }
        }
        ...
        _updateBaseData() {
          ...
          if (this._source.points().length >= 5) {
            ...
            (this._cdRetracement =
              ...
              (this._xdRetracement =
                Math.round(
                  1e3 * Math.abs((r.price - i.price) / (e.price - i.price))
                ) / 1e3);
          }
        }
      }
      ...
      class p extends u.LineSourcePaneView {
        ...
        _updateImpl() {
          ...
          if (
            ...
            i.fillBackground &&
              i.fillBackground.value() &&
              (o.backgroundColor = i.backgroundColor.value()),
            i.drawBorder &&
              i.drawBorder.value() &&
              (o.borderColor = i.borderColor.value()),
            i.wordWrap &&
              i.wordWrap.value() &&
              (o.wordWrapWidth = i.wordWrapWidth.value()),
            ...
            e.isPriceDencityLog() &&
              ...
              (n =
                t.height() /
                (Object(d.toLog)(i.maxValue()) -
                  Object(d.toLog)(i.minValue()))),
              !e.isPriceDencityLog() &&
                t.isLog() &&
                (n =
                  t.height() /
                  (Object(d.fromLog)(i.maxValue()) -
                    Object(d.fromLog)(i.minValue())));
            const s = e.priceDencity();
            void 0 !== s && (o.scaleY = n / s),
              (void 0 === s || void 0 === o.scaleY || o.scaleY <= 0) &&
                delete o.scaleY;
          }
          this._textRenderer.setData(o);
          ...
          if (u && !this._noSelection) {
            ...
            if (o.wordWrapWidth) {
              ...
              (i.data = 0),
                e.append(
                  this.createLineAnchor({ points: [i], pointsCursorType: _ }, 0)
                );
            }
      ...
      t.EllipsePaneView = class extends d {
        ...
        _updateImpl() {
          if (
            ...
            t.append(
              this.createLineAnchor(
                { points: [_, g, v, w], pointsCursorType: m },
                0
              )
            ),
              (this._renderer = t);
    ...
    ocVb: function (e, t, i) {
      ...
      t.TrendLinePaneView = class extends a {
        ...
        destroy() {
          this._cache && (this._cache.destroy(), (this._cache = null)),
            y.onAllIconsReady().unsubscribeAll(this);
        }
        _updateImpl() {
        ...
        _statLabelData() {
          ...
          if (_.showPriceRange.value() && this._source.priceScale()) {
            ...
            e =
              ...
              " (" +
              this._percentageFormatter.format(100 * f) +
              ")";
          ...
          if (S || b) {
            ...
            (a = this._source.pointToScreenPoint(d)[0].subtract(P)),
          ...
          if (m || y || b) {
            if (
              ...
              m &&
                ((n = d.index - h.index),
                (t += s("{count} bars").format({ count: R(n) }))),
              y)
            ) {
          ...
          S &&
            (o > 0 &&
              ((a = a.normalized()), (x = Math.acos(a.x)), a.y > 0 && (x = -x)),
            "number" != typeof x ||
              TradingView.isNaN(x) ||
          ...
          if (
            ...
            if (!(this._points.length < 2)) {
              ...
              this._model.lineBeingCreated() === this._source && m.pop(),
                a.append(
                  this.createLineAnchor({ points: m, pointsCursorType: h }, 0)
                ),
                (this._renderer = a);
            }
          }
      ...
      class l extends o {
        ...
        _drawArrow(e, t, i) {
          ...
          e.translate(t - 2, i),
            ...
            CanvasEx.drawArrow(e, 0, 0, 0, r, 4),
            e.restore();
        }
        _drawText(e, t, i) {
              ...
              if (0 !== s.length && null !== s.last()) {
                ...
                if (a) {
                  ...
                  if (
                    ...
                    (T = new r(y, this._entryLevel)),
                      (S = new r(b, this._closeLevel));
                    ((I = {}).points = [T, S]),
                      (I.color = "white"),
                      (I.linewidth = 0),
                      (I.backcolor = w.stopBackground.value()),
                    ...
                    var P =
                      ...
                      100 *
                        (1 -
                          (L = 0.01 * w.stopBackgroundTransparency.value()) *
                            L *
                            L);
                    (I.transparency = P),
                      (I.extendLeft = !1),
                    ...
                    var L,
                      C =
                        ...
                        100 *
                          (1 -
                            (L =
                              0.01 * w.profitBackgroundTransparency.value()) *
                              L *
                              L);
                    (I.transparency = C),
                      (I.extendLeft = !1),
                  ...
                  (T = new r(m, this._points[g.Entry].y)),
                    (S = new r(R, this._points[g.Entry].y));
                  ...
                  var V = new r(
                    ...
                    H = "",
                    W = "",
                    F = this._numericFormatter.format(
                      Math.round(100 * j) / 100
                    );
                  this._points[1] &&
                    void 0 !== this._pl &&
                    (W = this._source
                  ...
                  if (w.compact.value())
                    ...
                    var q = this._isClosed
                      ? this.i18nCache.closed
                      : this.i18nCache.open;
                    (H += W
                      ? this.i18nCache.pnl.format({ status: q, pnl: W }) + ", "
                      : ""),
                  ...
                  this._pl < 0
                    ? (G = w.stopBackground.value())
                    : this._pl > 0 && (G = w.profitBackground.value()),
                    O(this._middleLabelRenderer, V, H, G, "middle", 0, "white");
                  (T = new r(m, this._stopLevel)),
                    (S = new r(R, this._stopLevel));
                  ...
                  (H = w.compact.value()
                    ...
                    : this.i18nCache.stop.format({
                        stopChange: v(
                          this._source.ownerSource().formatter().format(k)
                        ),
                        stopChangePercent: v(
                          this._percentageFormatter.format(A)
                        ),
                        stopChangePip: this._pipFormatter
                          ? v(this._pipFormatter.format(k))
                          : "",
                    ...
                    O(
                      ...
                      V,
                      H,
                      w.stopBackground.value(),
                      N < D ? "bottom" : "top",
                      0
                    );
                  (T = new r(m, this._profitLevel)),
                    (S = new r(R, this._profitLevel));
                  ...
                  (H = w.compact.value()
                    ...
                    : this.i18nCache.target.format({
                        profitChange: v(
                          this._source.ownerSource().formatter().format(E)
                        ),
                        profitChangePercent: v(
                          this._percentageFormatter.format(z)
                        ),
                        profitChangePip: this._pipFormatter
                          ? v(this._pipFormatter.format(E))
                          : "",
    ...
    wacn: function (e, t, i) {
      ...
      class _ {
        ...
        setData(e) {
          ...
          if (
            ...
            (Object(a.distanceToLine)(t, i, r).distance < 1e-6 &&
              Object(a.distanceToLine)(t, i, s).distance < 1e-6)
          )
            this._selectedRenderer = null;
          else {
            null !==
            Object(o.intersectLines)(
              Object(n.lineThroughPoints)(t, i),
              Object(n.lineThroughPoints)(r, s)
            )
      ...
      class p extends u.ScaledPaneRenderer {
        ...
        _visiblePolygons(e) {
          ...
          const h = Object(o.intersectLines)(
            Object(n.lineThroughPoints)(i, s),
            Object(n.lineThroughPoints)(a, l)
          );
          if (null === h) return [];
          const d = [
              new n.Point(0, 0),
      ...
      function v(e, t) {
        const [i, r] = t.points;
        return (
          t.extendleft || (e = g(e, i.x, r.x)),
          t.extendright || (e = g(e, r.x, i.x)),
          e
        );
      }
    },
    wdUH: function (e, t, i) {
      ...
      class d extends n.LineSourcePaneView {
        ...
        _updateImpl() {
          ...
          this._prepareLevels(o, f),
            this._prepareFanLines(o, f),
            this._prepareArcs(o, f);
          const g = [l, s[1]];
          p.lineBeingCreated() === e && g.pop(),
            o.append(this.createLineAnchor({ points: g }, 0)),
            (this._renderer = o);
        }
        _initRenderers() {
          const e = this._getSource(),
            ...
            if (null !== this._model.timeScale().visibleBarsStrictRange()) {
              ...
              for (var n = v ? v.index - e.index : 1, l = 1; l <= 11; l++) {
                ...
                if (u.visible.value()) {
                  ...
                  t.showLabels.value() &&
                    ((p.text = u.coeff.value()),
                    (p.y = this._source.priceScale().height())),
                    this._levels.push(p);
                }
              }
              var f = new d();
            ...
            function () {
              ...
              for (var i = 0; i < e.cells.length; i++) {
                ...
                (this._cache.fillStyle = t.items[i].color),
                  this._cache.fillText(n.text, n.left, r);
              }
            }.bind(this)
          );
        }),
        ...
        (l.prototype._effectiveStatesEquals = function (e, t) {
          ...
          for (var o = 0; o < e.items.length; o++)
            if (
              ((n = e.items[o]),
              (s = t.items[o]),
              n.coeff !== s.coeff || n.color !== s.color)
            )
              return !1;
          return !0;
        }),
          ...
          if (
            ...
            if (!(this._floatPoints.length < 2)) {
              ...
              for (p = 0; p < this._hlevels.length; p++) {
                (e = new r(S, this._hlevels[p].y)),
                  (t = new r(L, this._hlevels[p].y));
              ...
              for (p = 0; p < this._vlevels.length; p++) {
                (e = new r(this._vlevels[p].x, P)),
                  (t = new r(this._vlevels[p].x, C));
                if (i.grid.visible.value()) {
                  N = {
                    points: [e, t],
                    width: this._model.timeScale().width(),
              ...
              for (
                e = this._floatPoints[0], t = this._floatPoints[1], p = 0;
                p < this._hlevels.length;
                p++
              ) {
    ...
    "y/56": function (e, t, i) {
      ...
      class d extends h.ScaledPaneRenderer {
        ...
        doesIntersectWithBox(e) {
          return (
            null !== this._data && Object(o.pointInBox)(this._data.point, e)
          );
        }
        _drawImpl(e) {
          null !== this._data &&
